import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, e as renderTemplate, d as renderComponent, s as spreadAttributes } from '../chunks/astro/server_BujBp8IR.mjs';
import { q as query, a as $$ContentRenderer, $ as $$BaseLayout, n as roots, k as sortByOrder } from '../chunks/BaseLayout_BLCbETNX.mjs';
import { s as siteData } from '../chunks/siteData_DTT4mimC.mjs';
import { $ as $$DoubleCard, a as $$CTASection } from '../chunks/DoubleCard_Fv5Prhk0.mjs';
import 'piccolore';
import { $ as $$SectionHeader, B as Button, a as animationProps } from '../chunks/accordion_CNWWAjUA.mjs';
import 'clsx';
/* empty css                                 */
...
const $$ScrollIndicator = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute(`scroll-indicator absolute bottom-16 lg:bottom-12 left-1/2 -translate-x-1/2 cursor-pointer no-underline z-20 ${className}`, "class")} aria-label="Scroll down for more content" data-astro-cid-7ivj2o3m> <div class="flex items-center justify-center p-1 border border-muted rounded-full shadow-lg transition-all duration-300 ease-in-out" data-astro-cid-7ivj2o3m> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-muted transition-all duration-300 w-4 h-4 md:w-5 md:h-5 hover:translate-y-0.5" data-astro-cid-7ivj2o3m> <path d="M12 5v14M19 12l-7 7-7-7" data-astro-cid-7ivj2o3m></path> </svg> </div> </a> `;
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Home", "description": siteData.description }, { "default": ($$result2) => renderTemplate`    ${renderComponent($$result2, "FrontPageHero", $$FrontPageHero, { "heading": heroHeading, "description": heroDescription, "primaryCTA": {
    ...
    text: "They're our specialty."
      ...
      columns={3}
      filterSize="sm"
    /> --> <!-- Website Benefits --> ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("benefits").orderBy(sortByOrder()), "variant": "BenefitsVariant", "columns": 2, "gap": "lg", "title": "Why Choose Us", "heading": "What Makes Our Websites Different", ",": true })} <!-- About Us Two-Column Section --> <!-- <ContentRenderer
