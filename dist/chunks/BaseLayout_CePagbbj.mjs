...
import 'piccolore';
import 'clsx';
import { s as siteData, d as ctaData } from './hvac_DDMnHj8t.mjs';
/* empty css                         */
/* empty css                          */
/* empty css                              */
import { b as shouldShowCollectionCTA, $ as $$SectionHeader, t as toArray, B as Button, d as $$ContentBridge, A as Accordion, H as Heading, _ as __vite_glob_0_26, P as POSTER_SRC } from './accordion_kHxJbK3j.mjs';
import { jsx, jsxs, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { F as FeatureCard } from './feature-cards_B93OCfsh.mjs';
...
import { u as useLazyLoad, L as LazyCookieConsent } from './lazy-utils_BbeCaMwy.mjs';
/* empty css                                 */
/* empty css                                                                              */
/* empty css                                     */
import { u as useVisibility, a as useScrollInteraction } from './visibility-hooks_DAJzksBB.mjs';
/* empty css                                                                      */
import { isRemoteAllowed } from '@astrojs/internal-helpers/remote';
import * as mime from 'mrmime';
/* empty css                                                                   */
import { I as IconListItem, a as Icon, A as AnimatedBorder } from './ui-primitives_DpsQ44ud.mjs';
import { createPortal } from 'react-dom';
/* empty css                                                                             */
import { P as PortfolioScreenShowcase, b as PortfolioCarousel, T as TechStackSection, _ as __vite_glob_0_23 } from './carousels_BWiHnypF.mjs';
/* empty css                                                               */
import { D as DarkLightToggle } from './theme-toggle_aG8Y-D1q.mjs';
import { A as AccentPicker } from './theme-accent_Dhj6RQ1o.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DgE63z2U.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_Dm61R5mQ.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_B5QPtYpb.mjs');
...
async function buildRelationshipGraph(options = {}) {
  ...
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_BiDhzEep.mjs');
...
const $$PortfolioScreenVariant = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`relative overflow-hidden p-6 ${className}`.trim(), "class")}> <div class="relative w-full max-w-4xl mx-auto h-[420px] sm:h-[520px] lg:h-[600px]"> <div class="relative h-full"> ${renderComponent($$result, "PortfolioScreenShowcase", PortfolioScreenShowcase, { "client:visible": true, ...showcaseProps, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/PortfolioScreenShowcase", "client:component-export": "default" })} </div> </div> </section>`;
...
const $$StatCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(cardClasses, "class")}> <!-- Animated border effect via CSS --> <div class="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-accent/30 transition-colors duration-300 pointer-events-none"></div> <p class="text-heading text-4xl font-bold"> ${shouldAnimate && typeof value === "number" ? renderTemplate`${renderComponent($$result, "Counter", $$Counter, { "start": startValue, "end": value, "decimals": decimalPlaces, "prefix": prefix, "suffix": suffix, "class": "leading-none" })}` : fallbackText || "\u2014"} </p> ${title && renderTemplate`<p class="text-muted text-sm uppercase tracking-[0.35em] mt-2"> ${title} </p>`} ${description && renderTemplate`<p class="text-muted text-sm leading-relaxed mt-3"> ${description} </p>`} </div>`;
...
const $$TwoColumnImageVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  })} </div>`}  ${showCTA && renderTemplate`<div class="mt-8"> ${renderComponent($$result, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary" }, { "default": ($$result2) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> </div> </div> </section>`;
...
const $$Logo = createComponent(($$result, $$props, $$slots) => {
  ...
  const DEFAULT_LOGO_CLASSES = "block w-[43px] h-[43px] lg:w-[45px] lg:h-[45px] object-contain";
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal_BiZ4KFUe.mjs'));
...
function AccessibilityButton() {
  const { Component: Modal, isOpen, close } = useLazyLoad(
    () => import('./AccessibilityModal_DuXJv0uK.mjs'),
...
const $$PreferencesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ConsentScript", $$ConsentScript, {})}${renderComponent($$result, "BrowserTranslateScript", $$BrowserTranslateScript, { "enableNative": true, "enableGoogle": true })}${maybeRenderHead()}<div${addAttribute(wrapperClasses, "class")}> ${showHeading && renderTemplate`${renderComponent($$result, "DividerHeading", DividerHeading, { "title": "Preferences", "className": "mb-4" })}`} <div${addAttribute(itemsClasses, "class")}>  <a href="/privacy-policy#ccpa-rights"${addAttribute(linkClasses, "class")}>Do Not Sell My Personal Information</a>  ${renderComponent($$result, "CookiePreferencesButton", CookiePreferencesButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/consent/components/CookiePreferencesButton", "client:component-export": "default" })} ${renderComponent($$result, "LazyCookieConsentBanner", LazyCookieConsent, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@/integrations/preferences/consent/components/CookieConsentBanner/Lazy", "client:component-export": "default" })}  ${renderComponent($$result, "AccessibilityButton", AccessibilityButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/accessibility/components/AccessibilityButton", "client:component-export": "default" })} </div> </div>`;
...
export { $$BaseLayout as $, __vite_glob_0_3$1 as A, __vite_glob_0_4$1 as B, __vite_glob_0_5$1 as C, __vite_glob_0_6$1 as D, __vite_glob_0_7$1 as E, FormWrapper as F, __vite_glob_0_8$1 as G, __vite_glob_0_9$1 as H, Input as I, __vite_glob_0_10$1 as J, __vite_glob_0_11$1 as K, __vite_glob_0_12$1 as L, Modal$1 as M, __vite_glob_0_13$1 as N, __vite_glob_0_14$1 as O, __vite_glob_0_15$1 as P, __vite_glob_0_16$1 as Q, Textarea as T, __ASTRO_IMAGE_IMPORT_18zSQ8 as _, $$ContentRenderer as a, formatPhoneNumber as b, createSvgComponent as c, getCollection as d, getItemKey as e, find as f, getCollectionMeta as g, shouldItemHavePage as h, shouldItemUseRootPath as i, baseService as j, __ASTRO_IMAGE_IMPORT_s0yHl as k, roots as l, sortByOrder as m, shouldCollectionHavePage as n, collections as o, parseQuality as p, query as q, related as r, shouldProcessCollection as s, isCollectionReference as t, capitalizeWords as u, getItemProperty as v, __vite_glob_0_0 as w, __vite_glob_0_0$1 as x, __vite_glob_0_1 as y, __vite_glob_0_2$1 as z };
