...
import { LuSparkles, LuSettings, LuSend, LuPlus, LuPhone, LuMinus, LuMail, LuLock, LuLinkedin, LuLayers, LuInstagram, LuImage, LuGlobe, LuGithub, LuContact, LuCode, LuClock, LuChevronRight, LuCheck, LuBot, LuBookOpen, LuArrowUpRight, LuArrowRight, LuArrowLeft } from 'react-icons/lu';
import { FaWordpress, FaWandMagicSparkles, FaUtensils, FaUniversalAccess, FaTruckFast, FaTrophy, FaStore, FaShopify, FaShieldHeart, FaShieldHalved, FaServer, FaScrewdriverWrench, FaRocket, FaRobot, FaReact, FaPython, FaPuzzlePiece, FaPlug, FaPhp, FaPenToSquare, FaPenNib, FaPaintbrush, FaNodeJs, FaMobileScreenButton, FaMagnifyingGlassChart, FaMagnifyingGlass, FaLocationDot, FaListCheck, FaLifeRing, FaLayerGroup, FaLaptop, FaKey, FaJs, FaHtml5, FaHelmetSafety, FaHeartPulse, FaHeadset, FaHandshake, FaGithub, FaFlask, FaFileLines, FaFigma, FaFeatherPointed, FaFeather, FaEnvelopeOpenText, FaEnvelopeCircleCheck, FaDatabase, FaCubes, FaCss3Alt, FaCrown, FaCoins, FaCode, FaCloudflare, FaClone, FaClockRotateLeft, FaClock, FaChartSimple, FaChartPie, FaChartLine, FaCartShopping, FaCartArrowDown, FaCamera, FaCalendarCheck, FaBullseye, FaBriefcase, FaBoxesStacked, FaBoxOpen, FaBolt, FaBagShopping, FaAws, FaAward, FaArrowsUpDownLeftRight, FaArrowsRotate, FaArrowTrendUp } from 'react-icons/fa6';
