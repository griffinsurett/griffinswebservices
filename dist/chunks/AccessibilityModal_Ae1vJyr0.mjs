...
import { useEffect, useId, useState, useCallback, useRef, memo, useTransition } from 'react';
import { M as Modal } from './BaseLayout_DpejhLLs.mjs';
import { u as useLocalStorageState } from './theme-accent_BMeLCr3J.mjs';
import { A as AnimatedBorder } from './ui-primitives_Bsx-jmXS.mjs';
import { T as ToggleControl } from './ToggleControl_BAq_4IfG.mjs';
import { B as Button } from './accordion_B-QbiZo0.mjs';
import { u as useLanguageSwitcher } from './theme-language_HN0clqaR.mjs';
/* empty css                                     */
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          requiresConsent && /* @__PURE__ */ jsx("div", { className: "px-4 py-3 bg-yellow-50 border-b border-yellow-200 text-sm text-yellow-800", children: "Enable functional cookies to use translation" }),
          supportedLanguages.map((language) => /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              style: requiresConsent && language.code !== "en" ? { opacity: 0.5, cursor: "not-allowed" } : void 0,
              children: [
