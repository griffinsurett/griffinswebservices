import { g as createVNode, F as Fragment$1, _ as __astro_tag_component__ } from './astro/server_BujBp8IR.mjs';
...
function AIChatSimulation({
  ...
  return /* @__PURE__ */ jsxs(DecorativeWrapper, { className: `bg-text/10 rounded-lg overflow-hidden ${className}`, children: [
