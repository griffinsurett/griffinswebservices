...
function SecureBrowserBar({
  ...
  return /* @__PURE__ */ jsx(DecorativeWrapper, { className: `bg-text/10 rounded-lg p-3 select-none pointer-events-none ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
...
const frontmatter = {
  ...
  "order": 5,
  "solutions": ["websites", "business-websites", "e-commerce-websites", "web-applications"]
};
...
const file = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/benefits/security-minded-by-design.mdx";
...
Content.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/benefits/security-minded-by-design.mdx";
