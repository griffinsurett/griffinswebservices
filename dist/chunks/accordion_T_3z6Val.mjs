...
import { A as AnimatedBorder, I as IconListItem, a as Icon } from './ui-primitives_BW0hwiYo.mjs';
...
import 'piccolore';
import { u as useVisibility } from './visibility-hooks_h8bFi65s.mjs';
import { u as useEngagementAutoplay } from './engagement-hooks_CihbH8F6.mjs';
...
function VideoAccordion({
  ...
  const effectiveIndex = activeIndex < 0 ? 0 : Math.min(activeIndex, safeItems.length - 1);
  const activeItem = safeItems[effectiveIndex];
  return /* @__PURE__ */ jsx(
    "div",
    {
      ref: wrapRef,
