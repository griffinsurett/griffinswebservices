...
import { A as AnimatedBorder, I as IconListItem, a as Icon } from './ui-primitives_B0JjTLio.mjs';
...
import { u as useEngagementAutoplay } from './engagement-hooks_CHyvIMzv.mjs';
...
const Video = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      clientLoadPlaceholder && placeholderSrc && /* @__PURE__ */ jsx(
        "img",
        {
          src: placeholderSrc,
...
export { $$SectionHeader as $, Accordion as A, Button as B, Heading as H, POSTER_SRC as P, Video as V, __vite_glob_0_26 as _, animationProps as a, shouldShowCollectionCTA as b, createIntersectionObserver as c, $$ContentBridge as d, generateVideoPoster as g, staggeredAnimationProps as s, toArray as t };
