...
import { LuSparkles, LuSettings, LuSend, LuPlus, LuPhone, LuMinus, LuMail, LuLock, LuLinkedin, LuLayers, LuInstagram, LuImage, LuGlobe, LuGithub, LuCode, LuClock, LuChevronRight, LuCheck, LuBot, LuBookOpen, LuArrowUpRight, LuArrowRight, LuArrowLeft } from 'react-icons/lu';
import { FaWordpress, FaWandMagicSparkles, FaUtensils, FaUniversalAccess, FaShopify, FaShieldHeart, FaShieldHalved, FaServer, FaScrewdriverWrench, FaScaleBalanced, FaRocket, FaRobot, FaReact, FaPython, FaPhp, FaPenNib, FaPalette, FaNodeJs, FaMobileScreenButton, FaMagnifyingGlassChart, FaLink, FaLifeRing, FaLayerGroup, FaLaptop, FaJs, FaHtml5, FaHelmetSafety, FaHeartPulse, FaHeadset, FaHandshake, FaGithub, FaGears, FaFileLines, FaFigma, FaFeather, FaEye, FaDumbbell, FaDisplay, FaCss3Alt, FaCookieBite, FaCompass, FaCode, FaCloudflare, FaClockRotateLeft, FaChartLine, FaCartShopping, FaBullseye, FaBriefcase, FaBoxOpen, FaBolt, FaAws, FaArrowsUpDownLeftRight } from 'react-icons/fa6';
