async function getMod$f() {
						return import('./certified-bag-chasers-light_PBnQHwjg.mjs');
					}
...
const certifiedBagChasersLight = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$f
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$e() {
						return import('./can-you-collaborate-with-our-team_CrLcyItd.mjs');
					}
...
const canYouCollaborateWithOurTeam = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
async function getMod$c() {
						return import('./can-you-redesign-my-current-site_Ah4K3CLl.mjs');
					}
...
const canYouRedesignMyCurrentSite = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
async function getMod$a() {
						return import('./custom-full-stack-applications_CyHlBi7S.mjs');
					}
...
async function getMod$9() {
						return import('./accessibility-compliance_Bbmtkmpw.mjs');
					}
...
const accessibilityCompliance = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
async function getMod$7() {
						return import('./full-stack-web-development_DV_w1eEJ.mjs');
					}
...
const fullStackWebDevelopment = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$7
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$6() {
						return import('./managed-website-hosting_ok5kmizM.mjs');
					}
...
const managedWebsiteHosting = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$6
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$5() {
						return import('./support-that-sticks-around_KoLAvoyY.mjs');
					}
...
const supportThatSticksAround = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$5
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$4() {
						return import('./will-my-website-be-mobile-friendly_C6_pBCNd.mjs');
					}
...
const willMyWebsiteBeMobileFriendly = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$4
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$3() {
						return import('./performance-optimization_neayMN_t.mjs');
					}
...
const performanceOptimization = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
export { canYouCollaborateWithOurTeam as a, canYouHelpWithTheWordsAndImages as b, certifiedBagChasersLight as c, canYouRedesignMyCurrentSite as d, doYouHandleHostingAndMaintenance as e, customFullStackApplications as f, accessibilityCompliance as g, browserExtensionDevelopment as h, fullStackWebDevelopment as i, websiteMaintenanceSupport as j, websiteMigrationServices as k, managedWebsiteHosting as m, performanceOptimization as p, supportThatSticksAround as s, uptimeReliabilityMonitoring as u, willMyWebsiteBeMobileFriendly as w };
