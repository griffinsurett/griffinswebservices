async function getMod$f() {
						return import('./certified-bag-chasers-light_DzLGbzV-.mjs');
					}
					const collectedLinks$f = [];
					const collectedStyles$f = [];
...
async function getMod$9() {
						return import('./branding-agency-partnerships_DhTxnxO7.mjs');
					}
...
const brandingAgencyPartnerships = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$9
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$8() {
						return import('./flawless-mobile-responsiveness_BB4M7iC7.mjs');
					}
...
const flawlessMobileResponsiveness = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$8
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$7() {
						return import('./truly-scalable-architecture_5u2wa4EG.mjs');
					}
...
const trulyScalableArchitecture = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$7
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$6() {
						return import('./us-based-expert-development_CWmoikMj.mjs');
					}
...
const usBasedExpertDevelopment = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
async function getMod$3() {
						return import('./real-estate-professionals_HgXnIQ0Y.mjs');
					}
...
const realEstateProfessionals = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$3
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$2() {
						return import('./restaurants-food-service_9CbMJ7mc.mjs');
					}
...
const restaurantsFoodService = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$2
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod$1() {
						return import('./subscription-box-companies_DqezUL-a.mjs');
					}
...
const subscriptionBoxCompanies = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod$1
}, Symbol.toStringTag, { value: 'Module' }));

async function getMod() {
						return import('./window-door-installation_gyahpeFQ.mjs');
					}
					const collectedLinks = "@@ASTRO-LINKS@@";
					const collectedStyles = "@@ASTRO-STYLES@@";
					const defaultMod = { __astroPropagation: true, getMod, collectedLinks, collectedStyles, collectedScripts: [] };

const windowDoorInstallation = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: defaultMod
}, Symbol.toStringTag, { value: 'Module' }));

export { canYouCollaborateWithOurTeam as a, canYouRedesignMyCurrentSite as b, certifiedBagChasersLight as c, accessibilityCompliance as d, brandingAgencyPartnerships as e, fullStackWebDevelopment as f, flawlessMobileResponsiveness as g, restaurantsFoodService as h, windowDoorInstallation as i, managedWebsiteHosting as m, performanceOptimization as p, realEstateProfessionals as r, subscriptionBoxCompanies as s, trulyScalableArchitecture as t, usBasedExpertDevelopment as u, willMyWebsiteBeMobileFriendly as w };
