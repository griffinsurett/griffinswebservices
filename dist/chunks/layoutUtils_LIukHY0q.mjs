import { h as collections, i as isCollectionReference, j as find, $ as $$BaseLayout, F as FormWrapper, I as Input, T as Textarea, q as query, a as $$ContentRenderer, k as sortByOrder, r as related, l as capitalizeWords, m as getItemProperty, _ as __vite_glob_0_0 } from './BaseLayout_BLCbETNX.mjs';
import { c as createAstro, a as createComponent, d as renderComponent, e as renderTemplate, m as maybeRenderHead, b as addAttribute, r as renderSlot } from './astro/server_BujBp8IR.mjs';
import 'piccolore';
import { g as getImageSrc, a as getAuthorName } from './carousels_AhcqsHkf.mjs';
import { $ as $$SectionHeader } from './accordion_CNWWAjUA.mjs';
import { s as siteData } from './siteData_DTT4mimC.mjs';
import { $ as $$DoubleCard, a as $$CTASection } from './DoubleCard_Fv5Prhk0.mjs';
import './background_cXnKXnp7.mjs';
/* empty css                         */
import 'clsx';
...
const $$file$6 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/layouts/collections/BlogLayout.astro";
...
const $$CapabilitiesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const primaryCTAButton = ctaButtons.find((c) => c.variant === "primary");
  const mapCTAButton = (ctaItem) => ctaItem ? {
    text: ctaItem.text,
    link: ctaItem.link
  } : void 0;
  ...
  currentSlug ? related("solutions", "capabilities", currentSlug) : null;
  ...
  }, "id": "capabilities-quote-hero" })} ${benefits.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "items": benefits, "variant": "CardVariant", "title": "Benefits", "heading": {
    before: "Why",
    text: title,
    after: "matters for your business."
  }, "description": "Real results that matter for your bottom line.", "ctaHref": "#capabilities-quote-hero", "ctaText": "Get Your Free Quote", "columns": 3 })}`}${Content && renderTemplate`${renderComponent($$result2, "Content", Content, {})}`}${renderComponent($$result2, "DoubleCard", $$DoubleCard, {})} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": related("solutions", "capabilities", currentSlug), "variant": "CardVariant", "title": "Solutions", "heading": {
    before: "Solutions that include",
    text: displayTitle
  }, "description": `Explore our website packages that include ${displayTitle.toLowerCase()} as part of the build.`, "ctaHref": "#capabilities-quote-hero", "ctaText": "Get Your Free Quote", "columns": 3 })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("testimonials"), "variant": "TestimonialCarouselVariant" })} ${renderComponent($$result2, "CTASection", $$CTASection, { "id": "capabilities-page-cta", "className": "min-h-[60vh]", "title": cta?.title || `Need ${title} for your project?`, "heading": cta?.heading || {
    before: "Let's add",
    text: title,
...
const $$file$5 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/layouts/collections/CapabilitiesLayout.astro";
...
const $$file$4 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/layouts/collections/CollectionIndexLayout.astro";
...
const $$file$3 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/layouts/collections/CollectionLayout.astro";
...
const $$ServicesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { ...seoProps }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "QuoteHero", $$QuoteHero, { "title": title, "heading": heading, "description": heroDescription, "primaryCTA": {
    ...
    link: `/${collection}`,
    rightIcon: "lu:arrow-left"
  }, "id": "services-quote-hero" })}  ${benefits.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "items": benefits, "variant": "CardVariant", "title": "Benefits", "heading": {
    before: "Why choose",
    text: title,
    after: "for your business."
  }, "description": "Real results that matter for your bottom line.", "ctaHref": "#services-quote-hero", "ctaText": "Get Your Free Quote", "columns": 3 })}`}${Content && renderTemplate`${renderComponent($$result2, "Content", Content, {})}`}${renderComponent($$result2, "DoubleCard", $$DoubleCard, {})} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": related("capabilities", "solutions", currentSlug), "variant": "IconListVariant", "title": "What's Included", "heading": {
    before: "Everything included in your",
    text: displayTitle,
    after: "build."
  }, "description": `No surprises, no upsells\u2014just the full package to get your ${displayTitle.toLowerCase()} live and performing.`, "ctaHref": "#services-quote-hero", "ctaText": "Get Your Free Quote", "columns": 2 })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("testimonials"), "variant": "TestimonialCarouselVariant" })} ${renderComponent($$result2, "CTASection", $$CTASection, { "id": "services-page-cta", "className": "min-h-[60vh]", "title": cta?.title || `Ready to get started with a ${entry.slug}?`, "heading": cta?.heading || {
...
const $$SolutionsLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { ...seoProps }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "QuoteHero", $$QuoteHero, { "title": title, "heading": heading, "description": heroDescription, "primaryCTA": {
    ...
    link: `/${collection}`,
    rightIcon: "lu:arrow-left"
  }, "id": "solutions-quote-hero" })} ${benefits.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "items": benefits, "variant": "CardVariant", "title": "Benefits", "heading": {
    before: "Why choose",
    text: title,
    after: "for your business."
  }, "description": "Real results that matter for your bottom line.", "ctaHref": "#solutions-quote-hero", "ctaText": "Get Your Free Quote", "columns": 3 })}`}${Content && renderTemplate`${renderComponent($$result2, "Content", Content, {})}`}${renderComponent($$result2, "DoubleCard", $$DoubleCard, {})} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": related("capabilities", "solutions", currentSlug), "variant": "IconListVariant", "title": "What's Included", "heading": {
    before: "Everything included in your",
    text: displayTitle,
    after: "build."
  }, "description": `No surprises, no upsells\u2014just the full package to get your ${displayTitle.toLowerCase()} live and performing.`, "ctaHref": "#solutions-quote-hero", "ctaText": "Get Your Free Quote", "columns": 2 })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("testimonials"), "variant": "TestimonialCarouselVariant" })} ${renderComponent($$result2, "CTASection", $$CTASection, { "id": "solutions-page-cta", "className": "min-h-[60vh]", "title": cta?.title || `Ready to get started with a ${entry.slug}?`, "heading": cta?.heading || {
    before: "Let's build your",
    text: entry.slug,
    after: " today."
  }, "primaryCTA": mapCTAButton(primaryCTAButton) || {
...
const allLayouts = /* #__PURE__ */ Object.assign({"../BlogIndexLayout.astro": __vite_glob_0_0,"../BlogLayout.astro": __vite_glob_0_1,"../CapabilitiesLayout.astro": __vite_glob_0_2,"../CollectionIndexLayout.astro": __vite_glob_0_3,"../CollectionLayout.astro": __vite_glob_0_4,"../LegalLayout.astro": __vite_glob_0_5,"../ServicesLayout.astro": __vite_glob_0_6,"../SolutionsLayout.astro": __vite_glob_0_7});
