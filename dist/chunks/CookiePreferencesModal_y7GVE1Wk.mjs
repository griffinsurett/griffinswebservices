...
import { useId, memo, useTransition, useMemo, useState, useRef, useEffect } from 'react';
import { B as useCookieStorage, M as Modal, C as enableConsentedScripts } from './BaseLayout_BXen9sOm.mjs';
import { B as Button, A as Accordion } from './accordion_D0NzPMSA.mjs';
  ...
  return /* @__PURE__ */ jsxs(
    Modal,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative flex-1 min-h-0", children: /* @__PURE__ */ jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 mt-6 pt-4 shrink-0", children: [
          /* @__PURE__ */ jsx(
            Button,
            {
              variant: "secondary",
