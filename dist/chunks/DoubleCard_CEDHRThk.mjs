import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, d as renderComponent, e as renderTemplate, s as spreadAttributes } from './astro/server_CDqnDASo.mjs';
import 'piccolore';
import { $ as $$SectionHeader, B as Button, a as animationProps, H as Heading, l as logoImg } from './accordion_T_3z6Val.mjs';
import { q as query, a as $$ContentRenderer, o as getImage } from './BaseLayout_CwDjC27N.mjs';
...
const $$DoubleCard = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="min-h-screen w-full outer-section" data-astro-cid-bw24kgpy> <div class="inner-section flex flex-wrap gap-6" data-astro-cid-bw24kgpy> <div class="group flex w-full lg:flex-1 flex-col min-h-[400px] rounded-3xl overflow-hidden relative card-bg"${spreadAttributes(animationProps("fade-in-up", { once: false, threshold: 0.2, rootMargin: "-15% 0px -35% 0px" }))} data-astro-cid-bw24kgpy> <div class="flex flex-col p-6 space-y-2 relative z-10" data-astro-cid-bw24kgpy> <h2 class="text-3xl lg:text-4xl xl:text-5xl font-bold" data-astro-cid-bw24kgpy> ${renderComponent($$result, "Counter", Counter, { "end": 100, "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/Counter", "client:component-export": "default", "data-astro-cid-bw24kgpy": true })}+
</h2> <p class="text-text large-text leading-tight" data-astro-cid-bw24kgpy>
