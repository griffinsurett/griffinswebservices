import { c as createAstro, a as createComponent, e as renderTemplate, u as unescapeHTML, b as addAttribute, g as renderScript, d as renderComponent, m as maybeRenderHead, F as Fragment, _ as __astro_tag_component__, f as createVNode, A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, l as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, n as UnsupportedImageConversion, t as toStyleString, o as NoImageMetadata, p as FailedToFetchRemoteImageDimensions, q as ExpectedImageOptions, v as ExpectedNotESMImage, w as InvalidImageService, x as ImageMissingAlt, s as spreadAttributes, y as ExperimentalFontsNotEnabled, z as FontFamilyNotFound, r as renderSlot, B as FileGlobNotSupported, C as FileParserNotFound, D as LiveContentConfigError, j as AstroUserError, G as UnknownContentCollectionError, R as RenderUndefinedEntryError, H as renderUniqueStylesheet, J as renderScriptElement, K as createHeadAndContent, O as defineScriptVars, P as renderHead } from './astro/server_CJgvfkPK.mjs';
import 'piccolore';
import 'clsx';
...
/* empty css                          */
/* empty css                              */
import { $ as $$Section, b as shouldShowCollectionCTA, c as $$SectionHeader, t as toArray, B as Button, e as $$ContentBridge, A as Accordion, g as generateVideoPoster, V as Video, a as animationProps, H as Heading, P as POSTER_SRC, _ as __vite_glob_0_33, u as useMotionPreference } from './accordion_D0NzPMSA.mjs';
import { jsx, jsxs, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { F as FeatureCard } from './feature-cards_BCu4dYKz.mjs';
...
import { createContext, useState, useRef, Children, isValidElement, useEffect, useMemo, useId, useCallback, createElement, memo, lazy, Suspense, useTransition } from 'react';
import { createPortal } from 'react-dom';
/* empty css                                                                              */
/* empty css                                     */
import { u as useVisibility, a as useScrollInteraction } from './visibility-hooks_CBlb6Wug.mjs';
/* empty css                                                                      */
import * as mime from 'mrmime';
import { a as getAuthorName, F as FilterTabs, b as FilteredPortfolioCarousel, P as PortfolioScreenShowcase, c as PortfolioCarousel, T as TechStackSection, d as TestimonialCard, _ as __vite_glob_0_29 } from './carousels_DTF28dRj.mjs';
/* empty css                                                            */
/* empty css                                                                     */
/* empty css                                                               */
/* empty css                                                                  */
/* empty css                                                                              */
import { D as DarkLightToggle } from './theme-toggle_Cx7Nr74k.mjs';
import { A as AccentPicker } from './theme-accent_2yuQdu7o.mjs';
import { C as CircleCheckbox } from './theme-shared_-yritbxk.mjs';
...
var _a$9;
const $$Astro$Z = createAstro("https://griffinswebservices.com");
const $$SEO = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$Z, $$props, $$slots);
  Astro2.self = $$SEO;
  const fallbackImage = siteData.logo?.src || "/2dfavicons/android-chrome-512x512.png";
  const {
    title,
    description,
    image,
  ...
  const baseImageUrl = getImageUrl(image, fallbackImage);
  ...
  const structuredData = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": makeAbsolute(fallbackImage),
        "width": 60,
        "height": 60
      }
    },
...
const $$Theme = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$8 || (_a$8 = __template$8([`<!-- Favicons --><link rel="shortcut icon" href="/2dfavicons/favicon.ico"><link rel="icon" type="image/png" sizes="16x16" href="/2dfavicons/favicon-16x16.png"><link rel="icon" type="image/png" sizes="32x32" href="/2dfavicons/favicon-32x32.png"><link rel="apple-touch-icon" sizes="180x180" href="/2dfavicons/apple-touch-icon.png"><link rel="manifest" href="/2dfavicons/site.webmanifest"><link rel="icon" type="image/svg+xml" href="/2dfavicons/favicon.ico"><!-- PWA manifest (uncomment when ready) --><!-- <link rel="manifest" href="favicon.svg" /> --><!-- Color scheme support --><meta name="color-scheme" content="dark light"><meta name="theme-color" content="var(--color-bg3)"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><!-- Theme detection script (runs before content loads to prevent FOUC) --><script>
...
<\/script><!-- Deferred theme enhancements (non-blocking) -->`, "<!-- Scroll animations (deferred to avoid blocking initial render) -->", ""])), renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/Theme.astro?astro&type=script&index=0&lang.ts"), renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/Theme.astro?astro&type=script&index=1&lang.ts"));
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/Theme.astro", void 0);

const $$Astro$Y = createAstro("https://griffinswebservices.com");
const $$AccordionVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> <div class="flex flex-col lg:flex-row lg:gap-12">  ${showHeader && renderTemplate`<div class="lg:w-1/2 sticky-section lg:self-start"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": heading, "description": description, "className": "text-center lg:text-left max-w-3xl lg:max-w-none", "titleClassName": "tracking-[0.25em]", "headingClassName": "h2 mb-4", "descriptionClassName": "large-text text-text/80" })} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="hidden lg:block mt-8"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "size": "lg", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div>`}  ${safeItems.length > 0 && renderTemplate`<div${addAttribute(`${showHeader ? "lg:w-1/2" : "w-full"} mt-12 lg:mt-0`, "class")}> ${renderComponent($$result2, "ContentBridge", $$ContentBridge, { "items": safeItems, "bridgeId": id }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Fragment", Fragment, { "slot": "default" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "Accordion", Accordion, { "items": safeItems.map((item, index) => ({
    slug: item.slug,
    title: item.title || "Untitled",
    description: item.description,
    contentSlotId: `${id}-slot-${index}`
  })), "allowMultiple": allowMultiple, "className": "space-y-4", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/Accordion", "client:component-export": "default" })} ` })} ` })} </div>`} </div>  ${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center lg:hidden"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "size": "lg", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/AccordionVariant.astro", void 0);

const $$file$w = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/AccordionVariant.astro";
...
function CardRenderer({
  ...
  return /* @__PURE__ */ jsx("ul", { className: `${columnClasses$1[columns]} list-none ${className}`.trim(), children: safeItems.map((item, index) => {
...
const $$Astro$X = createAstro("https://griffinswebservices.com");
const $$BenefitsInlineVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="space-y-10"> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": heading, "description": description, "className": "text-center", "headingClassName": "h2 mb-4", "descriptionClassName": "text-lg text-muted max-w-2xl mx-auto" })}`} ${safeItems.length > 0 && renderTemplate`${renderComponent($$result2, "CardRenderer", CardRenderer, { "client:visible": true, "items": safeItems, "columns": columns, "featureCardProps": featureCardProps, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/CardRenderer", "client:component-export": "default" })}`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BenefitsInlineVariant.astro", void 0);

const $$file$v = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BenefitsInlineVariant.astro";
...
const $$Astro$W = createAstro("https://griffinswebservices.com");
const $$MasonryGrid = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`masonry-grid ${className}`, "class")}> <div class="masonry-column"> ${leftColumn.map((item) => renderTemplate`<article class="masonry-card" data-animate="fade-in-up" data-animate-threshold="0.15" data-animate-root-margin="-10% 0px -10% 0px"> <h3 class="text-xl font-semibold text-text mb-2">${item.title}</h3> ${item.description && renderTemplate`<p class="text-sm text-text/60 leading-relaxed">${item.description}</p>`} ${item.Content && renderTemplate`<div class="masonry-content mt-4"> ${renderComponent($$result, "item.Content", item.Content, {})} </div>`} </article>`)} </div> <div class="masonry-column"> ${rightColumn.map((item) => renderTemplate`<article class="masonry-card" data-animate="fade-in-up" data-animate-threshold="0.15" data-animate-root-margin="-10% 0px -10% 0px"> <h3 class="text-xl font-semibold text-text mb-2">${item.title}</h3> ${item.description && renderTemplate`<p class="text-sm text-text/60 leading-relaxed">${item.description}</p>`} ${item.Content && renderTemplate`<div class="masonry-content mt-4"> ${renderComponent($$result, "item.Content", item.Content, {})} </div>`} </article>`)} </div> </div>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/LoopTemplates/MasonryGrid.astro", void 0);

const $$Astro$V = createAstro("https://griffinswebservices.com");
const $$BenefitsVariant = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$V, $$props, $$slots);
  Astro2.self = $$BenefitsVariant;
  const {
    items = [],
    title,
    heading,
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`<div class="heading-padding"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": heading, "description": description, "className": "text-section" })} </div>`} ${renderComponent($$result2, "MasonryGrid", $$MasonryGrid, { "items": safeItems, "className": gridMarginClass })} ${showCTA && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BenefitsVariant.astro", void 0);

const $$file$u = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BenefitsVariant.astro";
const $$url$u = undefined;

const __vite_glob_0_2$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$BenefitsVariant,
  file: $$file$u,
  url: $$url$u
}, Symbol.toStringTag, { value: 'Module' }));
...
function BlogCard({
  ...
  return /* @__PURE__ */ jsx("div", { className: ["h-full", className].filter(Boolean).join(" "), children: /* @__PURE__ */ jsxs(
    AnimatedBorder,
    {
      ...
      linkProps: hasHref ? { href: url } : void 0,
      innerClassName: "card-bg overflow-hidden relative flex flex-col h-full",
      children: [
        /* @__PURE__ */ jsx("div", { className: "inner-card-style inner-card-color pointer-events-none opacity-80 z-10", "aria-hidden": true }),
        /* @__PURE__ */ jsx("div", { className: "inner-card-style inner-card-transition inner-card-color pointer-events-none z-20", "aria-hidden": true }),
        featuredImage && /* @__PURE__ */ jsx("div", { className: "relative w-full aspect-video overflow-hidden z-0", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: featuredImage,
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 relative z-30 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-heading text-xl font-semibold mb-2 line-clamp-2", children: title }),
          description && /* @__PURE__ */ jsx("p", { className: "text-text text-sm line-clamp-3", children: description }),
          (author || publishDate) && /* @__PURE__ */ jsxs(Fragment$1, { children: [
            /* @__PURE__ */ jsx("div", { className: "w-full h-px bg-primary/20 my-4" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              author?.image && /* @__PURE__ */ jsx(
                "img",
                {
                  src: author.image,
                  alt: author.name,
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-w-0", children: [
                author?.name && /* @__PURE__ */ jsx("span", { className: "text-heading text-sm font-medium truncate", children: author.name }),
                publishDate && /* @__PURE__ */ jsx(
                  "time",
                  {
                    dateTime: typeof publishDate === "string" ? publishDate : publishDate.toISOString(),
...
const $$Astro$U = createAstro("https://griffinswebservices.com");
const $$Video = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "VideoClient", Video, { "client:visible": true, "className": className, "wrapperClass": wrapperClass, "src": src, "poster": ssrPoster, "clientPosterSrc": deferredPosterSrc, "placeholderSrc": ssrPlaceholder, "clientPlaceholderSrc": clientPlaceholderSrc, "autoPlay": autoplay, "muted": muted, "loop": loop, "controls": controls, "playsInline": playsinline, "lazy": lazy, "clientLoadPlaceholder": clientLoadPlaceholder, "sourceType": src?.endsWith(".mov") ? "video/quicktime" : src?.endsWith(".webm") ? "video/webm" : "video/mp4", ...rest, "client:component-hydration": "visible", "client:component-path": "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Video/Video", "client:component-export": "default" })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Video/Video.astro", void 0);

const $$Astro$T = createAstro("https://griffinswebservices.com");
const $$CTASection = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `min-h-[80vh] flex items-center justify-center relative overflow-hidden ${className}` }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="relative z-10 inner-section flex"> <div class="h-auto lg:min-h-screen inner-section mx-auto flex flex-col justify-center items-center"> <div class="flex flex-col gap-2 lg:gap-4 justify-left items-start lg:justify-center lg:items-center hero-spacing lg:text-center w-full"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "className": "text-left lg:text-center w-full hero-spacing", "title": title, "heading": heading, "headingTag": "h2", "headingClassName": "text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight" })} <div class="flex flex-col lg:flex-row items-center gap-3 lg:gap-6"> ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("testimonials").where((entry) => entry.data.featured === true).limit(3), "variant": "TestimonialCirclesVariant", "className": "px-2 md:px-0", "counterStart": 10, "counterEnd": 100, "counterDuration": 1800, "counterSuffix": "+", "counterLabel": "Happy Clients" })} ${renderComponent($$result2, "Button", Button, { "href": primaryCTA.link, "variant": "primary", "size": "lg" }, { "default": ($$result3) => renderTemplate`${primaryCTA.text}` })} </div> </div> </div> </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/heroes/CTASection.astro", void 0);

const $$Astro$S = createAstro("https://griffinswebservices.com");
const $$TrustStatement = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$S, $$props, $$slots);
  Astro2.self = $$TrustStatement;
  const { text, className = "min-h-[40vh] flex items-center mx-auto inner-section" } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "tag": "aside", "class": `trust-statement ${className}`.trim(), "aria-label": "Trust statement", "animateOnce": false }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2 class="text-3xl md:text-4xl lg:text-5xl text-left lg:text-center">${text}</h2> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/TrustStatement.astro", void 0);
...
const url$i = "src/content/about-us/_meta.mdx";
const file$j = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/about-us/_meta.mdx";
const Content$i = (props = {}) => MDXContent$i({
  ...props,
  components: { Fragment: Fragment, ...props.components, },
});
Content$i[Symbol.for('mdx-component')] = true;
Content$i[Symbol.for('astro.needsHeadRendering')] = !Boolean(frontmatter$i.layout);
Content$i.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/about-us/_meta.mdx";
__astro_tag_component__(Content$i, 'astro:jsx');
...
const url$h = "src/content/authors/_meta.mdx";
const file$i = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/authors/_meta.mdx";
const Content$h = (props = {}) => MDXContent$h({
  ...props,
  components: { Fragment: Fragment, ...props.components, },
});
Content$h[Symbol.for('mdx-component')] = true;
Content$h[Symbol.for('astro.needsHeadRendering')] = !Boolean(frontmatter$h.layout);
Content$h.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/authors/_meta.mdx";
__astro_tag_component__(Content$h, 'astro:jsx');
...
const url$g = "src/content/benefits/_meta.mdx";
const file$h = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/benefits/_meta.mdx";
...
Content$g.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/benefits/_meta.mdx";
...
const $$Astro$R = createAstro("https://griffinswebservices.com");
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/astro/components/Image.astro", void 0);

const $$Astro$Q = createAstro("https://griffinswebservices.com");
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/astro/components/Picture.astro", void 0);
...
const $$Astro$P = createAstro("https://griffinswebservices.com");
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/astro/components/Font.astro", void 0);
...
const $$Astro$O = createAstro("https://griffinswebservices.com");
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/BackgroundMedia.astro", void 0);

const $$Astro$N = createAstro("https://griffinswebservices.com");
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  const heightStyle = minHeight ? `min-height: ${minHeight}` : void 0;
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": classes, "style": heightStyle, "animate": animate !== "none" ? animate : void 0, "animateRootMargin": animateRootMargin, "animateOnce": animateOnce, ...rest }, { "default": ($$result2) => renderTemplate`${backgroundMedia && renderTemplate`${renderComponent($$result2, "BackgroundMedia", $$BackgroundMedia, { "backgroundMedia": {
    ...backgroundMedia,
    image: backgroundMedia.image ? {
      ...backgroundMedia.image,
      aboveTheFold: true
      // Always LCP optimized for heroes
    } : void 0
  } })}`}${maybeRenderHead()}<div${addAttribute(`relative z-10 w-full ${innerClassName}`, "class")}> ${renderSlot($$result2, $$slots["default"])} </div> ${renderSlot($$result2, $$slots["after"])} ` })} `;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Hero.astro", void 0);
...
const $$SecondaryHero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Hero", $$Hero, { "class": `card-bg landscape-hero ${className}`, "size": "medium", "minHeight": minHeight, "contentAlign": "center", "contentVerticalAlign": "center", "data-astro-cid-a6wr4frq": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="relative flex items-center justify-center overflow-hidden w-full"${addAttribute(`min-height: ${minHeight}`, "style")} data-astro-cid-a6wr4frq>  <!-- <BackgroundMedia backgroundMedia={backgroundMedia} /> -->  <div class="relative container mx-auto w-8/10 md:w-auto py-24 z-10" data-astro-cid-a6wr4frq> <div class="max-w-4xl mx-auto text-center text-bg" data-astro-cid-a6wr4frq> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": displayTitle, "titleClassName": "mb-0", "heading": displayHeading, "headingTag": "h1", "headingClassName": "text-4xl md:text-5xl lg:text-6xl font-bold drop-shadow-lg", "description": description, "descriptionClassName": "text-xl md:text-2xl opacity-95 drop-shadow-md leading-relaxed", "className": "text-center", "data-astro-cid-a6wr4frq": true })}  ${(publishDate || author || readingTime) && renderTemplate`<div class="flex flex-wrap justify-center gap-4 md:gap-6 text-sm md:text-base text-bg/90" data-astro-cid-a6wr4frq> ${publishDate && renderTemplate`<time${addAttribute(new Date(publishDate).toISOString(), "datetime")} class="flex items-center gap-2" data-astro-cid-a6wr4frq> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-a6wr4frq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-a6wr4frq></path> </svg> ${new Date(publishDate).toLocaleDateString()} </time>`} ${author && renderTemplate`<span class="flex items-center gap-2" data-astro-cid-a6wr4frq> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-a6wr4frq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-a6wr4frq></path> </svg>
By ${getAuthorName(author)} </span>`} ${readingTime && renderTemplate`<span class="flex items-center gap-2" data-astro-cid-a6wr4frq> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-a6wr4frq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-a6wr4frq></path> </svg> ${readingTime} min read
</span>`} </div>`} </div> </div> </div> ${renderSlot($$result2, $$slots["default"])} ` })} `;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/heroes/SecondaryHero.astro", void 0);
...
const meoncompImg = new Proxy({"src":"/assets/meoncomp-Clq1KPve.jpg","width":691,"height":518,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/assets/meoncomp.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/assets/meoncomp.jpg");
							return target[name];
						}
					});

const $$Astro$L = createAstro("https://griffinswebservices.com");
const $$Counter = createComponent(($$result, $$props, $$slots) => {
  ...
  const finalDisplay = resolvedDecimals > 0 ? end.toFixed(resolvedDecimals) : Math.round(end).toString();
  const initialDisplay = resolvedDecimals > 0 ? start.toFixed(resolvedDecimals) : Math.round(start).toString();
  return renderTemplate`${maybeRenderHead()}<span${addAttribute(["counter-wrapper", className], "class:list")} data-astro-cid-x63rdsgb> ${prefix && renderTemplate`<span class="counter-prefix" data-astro-cid-x63rdsgb>${prefix}</span>`} <span class="counter-value tabular-nums"${addAttribute(start, "data-start")}${addAttribute(end, "data-end")}${addAttribute(duration, "data-duration")}${addAttribute(resolvedDecimals, "data-decimals")}${addAttribute(finalDisplay, "data-final")}${addAttribute(`display: inline-block; min-width: ${minWidthCh}ch;`, "style")}${addAttribute(`${prefix}${finalDisplay}${suffix}`, "aria-label")} data-astro-cid-x63rdsgb>${initialDisplay}</span> ${suffix && renderTemplate`<span class="counter-suffix" data-astro-cid-x63rdsgb>${suffix}</span>`} </span>  ${renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Counter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Counter.astro", void 0);

const $$DoubleCard = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="min-h-screen w-full outer-section" data-astro-cid-u4ipd7gh> <div class="inner-section flex flex-wrap gap-6" data-astro-cid-u4ipd7gh> <div class="group flex w-full lg:flex-1 flex-col min-h-[400px] rounded-3xl overflow-hidden relative card-bg"${spreadAttributes(animationProps("fade-in-up", { once: false, threshold: 0.1, rootMargin: "-15% 0px -25% 0px" }))} data-astro-cid-u4ipd7gh> <div class="flex flex-col p-6 space-y-2 relative z-10" data-astro-cid-u4ipd7gh> <h2 class="text-3xl lg:text-4xl xl:text-5xl font-bold" data-astro-cid-u4ipd7gh> ${renderComponent($$result, "Counter", $$Counter, { "prefix": "$", "end": 2.5, "suffix": "M+", "data-astro-cid-u4ipd7gh": true })} </h2> <p class="text-text large-text leading-tight" role="heading" aria-level="3" data-astro-cid-u4ipd7gh>
Client Annual Revenue
</p> </div> <div class="absolute bottom-0 w-full h-110 -mb-42 lg:-mb-52 overflow-hidden z-0" data-astro-cid-u4ipd7gh> ${renderComponent($$result, "BackgroundMedia", $$BackgroundMedia, { "backgroundMedia": {
    image: {
      src: POSTER_SRC,
  ...
  }, "data-astro-cid-u4ipd7gh": true })} </div> </div> <div class="group flex w-full md:flex-1 lg:flex-2 flex-col md:flex-row min-h-[400px] rounded-3xl overflow-hidden card-bg relative"${spreadAttributes(animationProps("fade-in-right", { once: false, threshold: 0.25, rootMargin: "-10% 0px -15% 0px", delay: 300 }))} data-astro-cid-u4ipd7gh> <div class="relative flex-1 lg:rounded-br-[250px] overflow-hidden md:w-1/2 lg:mb-5 z-0 fade-image-shell" data-astro-cid-u4ipd7gh> ${renderComponent($$result, "BackgroundMedia", $$BackgroundMedia, { "backgroundMedia": {
    image: {
      src: meoncompImg,
  ...
  }, "data-astro-cid-u4ipd7gh": true })} </div> <div class="flex-1 flex flex-col gap-6 justify-center items-end p-6 lg:px-6 relative z-10" data-astro-cid-u4ipd7gh> <!-- <div class="inner-section">will be something</div> --> ${renderComponent($$result, "Heading", Heading, { "tagName": "h3", "className": "text-3xl lg:text-4xl lg:text-right text-left", "before": "We're a New Jersey based Web Agency that creates ", "text": "fast, engaging websites.", "textClass": "m-0 p-0 emphasized-text", "data-astro-cid-u4ipd7gh": true })} ${renderComponent($$result, "Button", Button, { "href": "/about-us", "variant": "secondary", "size": "lg", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default", "data-astro-cid-u4ipd7gh": true }, { "default": ($$result2) => renderTemplate`
More About Us
` })} </div> </div> </div> </section> `;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/sections/DoubleCard.astro", void 0);

const $$Astro$K = createAstro("https://griffinswebservices.com");
const $$BlogIndexLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { ...seoProps }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "SecondaryHero", $$SecondaryHero, { "title": pageTitle, "description": pageDescription, "image": heroImage })} ${maybeRenderHead()}<div> ${hasContent && Content ? (
    ...
    renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query(collectionName).orderBy(sortByDate("publishDate", "desc")), "variant": "BlogVariant", "columns": 2, "title": "Latest Articles", "heading": {
      before: "Stay informed.",
      text: "Read our latest insights."
    } })}`
  )} </div> ${renderComponent($$result2, "DoubleCard", $$DoubleCard, {})} ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/collections/BlogIndexLayout.astro", void 0);

const $$file$t = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/collections/BlogIndexLayout.astro";
...
const url$f = "src/content/blog/_meta.mdx";
const file$g = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/blog/_meta.mdx";
...
Content$f.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/blog/_meta.mdx";
...
const url$e = "src/content/capabilities/_meta.mdx";
const file$f = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/capabilities/_meta.mdx";
...
Content$e.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/capabilities/_meta.mdx";
...
const url$d = "src/content/contact-us/_meta.mdx";
const file$e = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/contact-us/_meta.mdx";
...
Content$d.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/contact-us/_meta.mdx";
...
const url$c = "src/content/faq/_meta.mdx";
const file$d = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/faq/_meta.mdx";
...
Content$c.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/faq/_meta.mdx";
...
const url$b = "src/content/features/_meta.mdx";
const file$c = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/features/_meta.mdx";
...
Content$b.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/features/_meta.mdx";
...
const url$a = "src/content/industries/_meta.mdx";
const file$b = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/industries/_meta.mdx";
...
Content$a.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/industries/_meta.mdx";
...
const url$9 = "src/content/legal/_meta.mdx";
const file$a = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/legal/_meta.mdx";
...
Content$9.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/legal/_meta.mdx";
...
const url$8 = "src/content/menu-items/_meta.mdx";
const file$9 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/menu-items/_meta.mdx";
...
Content$8.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/menu-items/_meta.mdx";
...
const url$7 = "src/content/menus/_meta.mdx";
const file$8 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/menus/_meta.mdx";
...
Content$7.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/menus/_meta.mdx";
...
const url$6 = "src/content/philosophy/_meta.mdx";
const file$7 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/philosophy/_meta.mdx";
...
Content$6.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/philosophy/_meta.mdx";
...
const file$6 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/projects/_meta.mdx";
...
Content$5.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/projects/_meta.mdx";
...
const file$5 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/social-media/_meta.mdx";
...
Content$4.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/social-media/_meta.mdx";
...
const file$4 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/solutions/_meta.mdx";
...
Content$3.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/solutions/_meta.mdx";
...
const file$3 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/stats/_meta.mdx";
...
Content$2.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/stats/_meta.mdx";
...
const file$2 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/technologies/_meta.mdx";
...
Content$1.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/technologies/_meta.mdx";
...
const file$1 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/testimonials/_meta.mdx";
...
Content.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/testimonials/_meta.mdx";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DrwU50Ye.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_B5y8o3c4.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DH7Ejn5f.mjs');
...
const ValueFormatter = z.enum(["phone", "email", "none"]).default("none");
const LinkMode = z.enum([
  "standard",
  // /{collection}/{slug}
  "root",
  // /{slug}
  "prefixed",
  // linkPrefix + value (for tel:, mailto:, etc.)
  "field",
  // Use 'link' field directly as URL
  "none"
  // No URL
]).default("standard");
const LinkBehaviorConfig = z.object({
  mode: LinkMode,
  // Field mappings
  link: z.string().default("url"),
  // Field containing URL (for 'field' mode)
  linkPrefix: z.string().default("linkPrefix"),
  // Field containing prefix (for 'prefixed' mode)
...
function shouldItemHavePageData(itemData, metaData, defaultValue = true, parentData) {
  const item = getItemData(itemData);
  const parent = parentData ? getItemData(parentData) : void 0;
  if (isDraft(item)) return false;
  if (item?.hasPage !== void 0) {
    return item.hasPage;
  }
  if (parent?.childHasPage !== void 0) {
    return parent.childHasPage;
  }
  if (item?.parent && metaData?.itemsChildHasPage !== void 0) {
    return metaData.itemsChildHasPage;
  }
  if (metaData?.itemsHasPage !== void 0) {
...
async function processCollectionMenus(modules, store) {
  ...
  for (const [path, mod] of metaModules) {
    ...
    if (data.itemsAddToMenu) {
      const itemsWithPages = /* @__PURE__ */ new Set();
      ...
      const hasDescendantWithPage = (slug, visited = /* @__PURE__ */ new Set()) => {
...
const excludeDrafts = (entry) => entry.data.draft !== true;
async function getPublishedCollection(collectionName) {
  const { getCollection } = await Promise.resolve().then(() => _astro_content);
  return getCollection(collectionName, excludeDrafts);
}

const mdxModules = /* #__PURE__ */ Object.assign({"../../content/about-us/_meta.mdx": __vite_glob_0_0$1,"../../content/authors/_meta.mdx": __vite_glob_0_1,"../../content/benefits/_meta.mdx": __vite_glob_0_2,"../../content/blog/_meta.mdx": __vite_glob_0_3$1,"../../content/capabilities/_meta.mdx": __vite_glob_0_4$1,"../../content/contact-us/_meta.mdx": __vite_glob_0_5$1,"../../content/faq/_meta.mdx": __vite_glob_0_6$1,"../../content/features/_meta.mdx": __vite_glob_0_7$1,"../../content/industries/_meta.mdx": __vite_glob_0_8$1,"../../content/legal/_meta.mdx": __vite_glob_0_9$1,"../../content/menu-items/_meta.mdx": __vite_glob_0_10$1,"../../content/menus/_meta.mdx": __vite_glob_0_11$1,"../../content/philosophy/_meta.mdx": __vite_glob_0_12$1,"../../content/projects/_meta.mdx": __vite_glob_0_13$1,"../../content/social-media/_meta.mdx": __vite_glob_0_14$1,"../../content/solutions/_meta.mdx": __vite_glob_0_15$1,"../../content/stats/_meta.mdx": __vite_glob_0_16$1,"../../content/technologies/_meta.mdx": __vite_glob_0_17$1,"../../content/testimonials/_meta.mdx": __vite_glob_0_18$1
...
function getFirstParentSlug(parent) {
  if (!parent) return void 0;
  if (Array.isArray(parent)) return parent[0];
  return parent;
}
async function prepareEntry(entry, collection, meta, entriesMap) {
  const { shouldItemHavePage, shouldItemUseRootPath } = await Promise.resolve().then(() => index);
  const { applyLinkBehavior, mergeLinkBehavior } = await import('./linkBehavior_BWVEQ1XW.mjs');
  const identifier = getItemKey(entry);
  const data = entry.data;
  const parentSlug = getFirstParentSlug(data.parent);
  const parentEntry = parentSlug && entriesMap ? entriesMap.get(parentSlug) : void 0;
...
async function buildRelationshipGraph(options = {}) {
  const { getPublishedCollection } = await import('./index_C9uKvl1p.mjs');
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_DZcfRGxU.mjs');
...
async function loadAllEntries(graph, collections, getPublishedCollection) {
...
function sortByDate(field = "publishDate", direction = "desc") {
  return (a, b) => {
    const aData = a.data;
    const bData = b.data;
...
class Query {
  ...
  async get() {
    ...
    if (Array.isArray(this._collection)) {
      ...
      entries = await getPublishedCollection(this._collection);
    }
...
const byTag = (collection, tags, limit) => {
  const tagList = (Array.isArray(tags) ? tags : [tags]).filter(Boolean);
  if (tagList.length === 0) {
    return query(collection).where(() => false).limit(0);
  }
  const filter = tagList.length === 1 ? whereArrayContains("tags", tagList[0]) : or(...tagList.map((tag) => whereArrayContains("tags", tag)));
  const q = query(collection).where(filter);
  return q;
};
const byItemKeys = (collection, keys) => {
  ...
  return query(collection).where((entry) => {
...
const children = (collection, parentId) => {
  const targetId = parentId ? normalizeId(parentId) : "";
  if (!targetId) {
    return query(collection).where(() => false);
  }
  return query(collection).where((entry) => {
    const parent2 = entry.data.parent;
    if (!parent2) return false;
    if (Array.isArray(parent2)) {
      return parent2.some((p) => {
        const id2 = typeof p === "string" ? p : p?.id || p?.slug || "";
        return normalizeId(id2) === targetId;
      });
    }
    const id = typeof parent2 === "string" ? parent2 : parent2?.id || parent2?.slug || "";
...
const $$Astro$J = createAstro("https://griffinswebservices.com");
const $$BlogVariant = createComponent(async ($$result, $$props, $$slots) => {
    ...
    safeItems.map(async (item) => {
      ...
      if (isCollectionReference(item.author)) {
        ...
        if (authorEntry) {
          ...
          if (data.featuredImage) {
            authorImage = typeof data.featuredImage === "string" ? data.featuredImage : data.featuredImage?.src?.src || data.featuredImage?.src;
          }
          authorData = {
      ...
      if (item.featuredImage) {
        if (typeof item.featuredImage === "string") {
          ...
          featuredImage = typeof item.featuredImage.src === "string" ? item.featuredImage.src : item.featuredImage.src?.src;
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section ${className}`.trim() }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`<div class="heading-padding"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description })} </div>`} ${resolvedItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} gap-8 list-none`, "class")}> ${resolvedItems.map((item, index) => renderTemplate`<li class="h-full" data-animate="fade-in-up"${addAttribute(shouldStagger ? String(getStaggerDelay(index)) : void 0, "data-animate-delay")} data-animate-threshold="0.15" data-animate-root-margin="-10% 0px -10% 0px"> ${renderComponent($$result2, "BlogCard", BlogCard, { "client:visible": true, "title": item.title, "description": item.description, "url": item.url, "featuredImage": item.featuredImage, "featuredImageAlt": item.featuredImageAlt, "publishDate": item.publishDate, "author": item.author, "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/BlogCard", "client:component-export": "default" })} </li>`)} </ul>`} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="mt-12 text-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "primary", "size": "lg" }, { "default": async ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BlogVariant.astro", void 0);

const $$file$s = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/BlogVariant.astro";
...
const $$Astro$I = createAstro("https://griffinswebservices.com");
const $$CardVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const effectiveColumns = Math.min(maxColumns, safeItems.length || 1);
  ...
  const gridMarginClass = showHeader ? "mt-12" : "";
  const showCTA = showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`<div${addAttribute(
    ctaInlineOnDesktop && showCTA ? "flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between" : "",
    "class"
  )}> <div${addAttribute(ctaInlineOnDesktop && showCTA ? "lg:flex-1" : "heading-padding", "class")}> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": ctaInlineOnDesktop && showCTA ? "text-section lg:text-left" : void 0, "descriptionClassName": ctaInlineOnDesktop && showCTA ? "large-text lg:text-left" : void 0 })} </div> ${ctaInlineOnDesktop && showCTA && renderTemplate`<div class="hidden lg:flex items-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div>`}  ${showBody ? renderTemplate`${renderComponent($$result2, "ContentBridge", $$ContentBridge, { "items": safeItems, "bridgeId": id }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Fragment", Fragment, { "slot": "default" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "CardRenderer", CardRenderer, { "client:visible": true, "items": safeItems.map((item, index) => ({
    ...item,
    contentSlotId: `${id}-slot-${index}`
  })), "columns": effectiveColumns, "showBody": showBody, "className": gridMarginClass, "getCardClassName": resolveCardClassName, "getRingDuration": resolveRingDuration, "featureCardProps": featureCardPropOverrides, "animation": {
    once: false,
    threshold: 0.15,
    rootMargin: "-10% 0px -10% 0px"
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/CardRenderer", "client:component-export": "default" })} ` })} ` })}` : renderTemplate`${renderComponent($$result2, "CardRenderer", CardRenderer, { "client:visible": true, "items": safeItems, "columns": effectiveColumns, "showBody": false, "className": gridMarginClass, "getCardClassName": resolveCardClassName, "getRingDuration": resolveRingDuration, "featureCardProps": featureCardPropOverrides, "animation": {
    once: false,
    threshold: 0.15,
    rootMargin: "-10% 0px -10% 0px"
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/CardRenderer", "client:component-export": "default" })}`} ${showCTA && renderTemplate`<div${addAttribute(`buttons-section-center ${ctaInlineOnDesktop ? "lg:hidden" : ""}`.trim(), "class")}> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/CardVariant.astro", void 0);

const $$file$r = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/CardVariant.astro";
...
const $$Astro$H = createAstro("https://griffinswebservices.com");
const $$ChecklistVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const showHeader = Boolean(title || heading || description);
  const showCTA = showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": "text-section" })}`} ${safeItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} gap-5 mt-8 list-none`, "class")}> ${safeItems.map((item) => {
    const itemIcon = item.icon || item.data?.icon || "lu:check";
    return renderTemplate`<li> ${renderComponent($$result2, "IconListItem", IconListItem, { "client:visible": true, "data": {
      icon: itemIcon,
      title: item.title,
      description: item.description
  ...
  })} </ul>`} ${showCTA && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ChecklistVariant.astro", void 0);

const $$file$q = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ChecklistVariant.astro";
...
const $$Astro$G = createAstro("https://griffinswebservices.com");
...
✕
</span> <div> ${item.title && renderTemplate`<p class="text-heading font-medium">${item.title}</p>`} ${item.description && renderTemplate`<p class="text-muted text-sm mt-0.5">${item.description}</p>`} </div> </li>`)} </ul>`} </div> </div> ${showButtonSection && ctaHref && ctaText && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref, "rightIcon": "lu:arrow-right", "variant": "primary", "size": "lg" }, { "default": ($$result3) => renderTemplate`${ctaText}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ComparisonVariant.astro", void 0);

const $$file$p = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ComparisonVariant.astro";
...
const $$Astro$F = createAstro("https://griffinswebservices.com");
const $$ContactListVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `${className}` }, { "default": ($$result2) => renderTemplate`  ${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<ul class="flex flex-col items-start justify-center gap-3 list-none"> ${safeItems.map((item) => {
    const href = item.url;
    const displayValue = item.displayValue ?? item.description;
    const iconName = item.icon ?? fallbackIcon;
    return renderTemplate`<li class="py-0"${addAttribute(item.slug, "data-contact-id")}> ${href ? renderTemplate`${renderComponent($$result2, "Button", Button, { "href": href, "variant": "link", "size": "sm", "aria-label": displayValue }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Icon", Icon, { "icon": iconName, "size": "md", "className": "w-5 h-5 mr-1 shrink-0 text-primary" })} <span class="text-base">${displayValue}</span> ` })}` : renderTemplate`<div class="flex items-center gap-3"> ${renderComponent($$result2, "Icon", Icon, { "icon": iconName, "size": "md", "className": "w-5 h-5 shrink-0 text-primary" })} <span class="text-heading font-semibold text-base"> ${displayValue} </span> </div>`} </li>`;
  })} </ul>`}` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ContactListVariant.astro", void 0);

const $$file$o = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ContactListVariant.astro";
...
function FormWrapper({
  ...
  const shouldUseNativeSubmission = useNativeFormSubmission && Boolean(formAction);
  ...
  return /* @__PURE__ */ jsx(FormContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxs(
    "form",
    {
      action: formAction,
      method: formMethod,
      onSubmit: shouldUseNativeSubmission ? void 0 : handleSubmit,
      className,
      noValidate: false,
      children: [
        ...
        includeTermsCheckbox && (!isMultiStep || currentStep === totalSteps - 1) && /* @__PURE__ */ jsx("div", { className: "relative z-10", children: /* @__PURE__ */ jsx(
          Checkbox,
          {
...
const $$Astro$E = createAstro("https://griffinswebservices.com");
const $$ContactForm = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$E, $$props, $$slots);
  Astro2.self = $$ContactForm;
  const { title, description, className = "" } = Astro2.props;
  const FORMSPREE_BASE_ACTION = "https://formspree.io/f/";
  const contactFormId = "mjkgojyo";
  const contactFormAction = `${FORMSPREE_BASE_ACTION}${contactFormId}` ;
...
const $$ContactVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const safeItems = toArray(items);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `py-16 w-full ${className}` }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col-reverse justify-center gap-4 lg:gap-8 items-start lg:flex-row inner-section"> <div class="flex flex-1"> ${safeItems.length > 0 && renderTemplate`<ul${addAttribute(`flex flex-wrap lg:flex-col gap-4 list-none w-full`, "class")}> ${safeItems.map((item) => renderTemplate`<li class="relative overflow-hidden w-full" data-animate="fade-in-up" data-animate-threshold="0.15" data-animate-root-margin="-10% 0px -10% 0px"> ${renderComponent($$result2, "FeatureCard", FeatureCard, { "client:visible": true, "data": {
    icon: item.icon,
    title: item.title,
    description: item.displayValue ?? item.description,
    url: item.url
  }, "ringDuration": 800, "listItemProps": {
    ...
    descriptionClassName: "text-lg text-text md:mt-0 mt-2",
    showDescription: true
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/FeatureCard", "client:component-export": "default" })} </li>`)} </ul>`} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="mt-12 text-left"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "primary", "size": "lg" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> <div class="flex flex-2 flex-col justify-between w-full"> ${renderComponent($$result2, "ContactForm", $$ContactForm, {})} </div> </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ContactVariant.astro", void 0);

const $$file$n = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ContactVariant.astro";
...
function detectGroupingField(items) {
  if (items.length === 0) return null;
  const sample = items.slice(0, 5);
  if (sample.some((item) => item.parent !== void 0 && item.parent !== null)) {
    return "parent";
  }
  if (sample.some((item) => Array.isArray(item.tags) && item.tags.length > 0)) {
    return "tags";
  }
  if (sample.some((item) => item.category !== void 0 && item.category !== null)) {
    return "category";
  }
...
function extractFilterOptions(items, field) {
    ...
    if (Array.isArray(value)) {
      for (const v of value) {
        ...
        if (existing) {
          ...
          const icon = typeof v === "object" ? v.icon : void 0;
          optionMap.set(key, {
...
function filterItemsByKey(items, filterKey, field) {
...
function useFilter(items, config) {
  const safeItems = Array.isArray(items) ? items : [];
  ...
  const handleSetActiveFilter = useCallback((key) => {
    setActiveFilter(key);
  }, []);
...
function FilteredCardRenderer({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "filtered-card-renderer", children: [
    /* @__PURE__ */ jsx(
      FilterTabs,
      {
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx(CardRenderer, { items: filteredItems, ...cardRendererProps })
      },
      activeFilter
    )
  ] });
...
const $$Astro$C = createAstro("https://griffinswebservices.com");
const $$FilteredCardVariant = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$C, $$props, $$slots);
  Astro2.self = $$FilteredCardVariant;
  const {
    items = [],
    title,
    heading,
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`<div${addAttribute(
    ctaInlineOnDesktop && showCTA ? "flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between" : "",
    "class"
  )}> <div${addAttribute(ctaInlineOnDesktop && showCTA ? "lg:flex-1" : "heading-padding", "class")}> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": ctaInlineOnDesktop && showCTA ? "text-section lg:text-left" : void 0, "descriptionClassName": ctaInlineOnDesktop && showCTA ? "large-text lg:text-left" : void 0 })} </div> ${ctaInlineOnDesktop && showCTA && renderTemplate`<div class="hidden lg:flex items-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div>`}  ${showBody ? renderTemplate`${renderComponent($$result2, "ContentBridge", $$ContentBridge, { "items": safeItems, "bridgeId": id }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Fragment", Fragment, { "slot": "default" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "FilteredCardRenderer", FilteredCardRenderer, { "client:visible": true, "items": safeItems.map((item, index) => ({
    ...item,
    contentSlotId: `${id}-slot-${index}`
  })), "filter": filter, "filterSize": filterSize, "filterClassName": filterClassName, "columns": columns, "showBody": showBody, "className": gridMarginClass, "getCardClassName": resolveCardClassName, "getRingDuration": resolveRingDuration, "featureCardProps": featureCardPropOverrides, "animation": {
    once: false,
    threshold: 0.15,
    rootMargin: "-10% 0px -10% 0px"
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/FilteredCardRenderer", "client:component-export": "default" })} ` })} ` })}` : renderTemplate`${renderComponent($$result2, "FilteredCardRenderer", FilteredCardRenderer, { "client:visible": true, "items": safeItems, "filter": filter, "filterSize": filterSize, "filterClassName": filterClassName, "columns": columns, "showBody": false, "className": gridMarginClass, "getCardClassName": resolveCardClassName, "getRingDuration": resolveRingDuration, "featureCardProps": featureCardPropOverrides, "animation": {
    once: false,
    threshold: 0.15,
    rootMargin: "-10% 0px -10% 0px"
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/FilteredCardRenderer", "client:component-export": "default" })}`} ${showCTA && renderTemplate`<div${addAttribute(`buttons-section-center ${ctaInlineOnDesktop ? "lg:hidden" : ""}`.trim(), "class")}> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/FilteredCardVariant.astro", void 0);

const $$file$m = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/FilteredCardVariant.astro";
const $$url$m = undefined;

const __vite_glob_0_9 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$FilteredCardVariant,
  file: $$file$m,
  url: $$url$m
}, Symbol.toStringTag, { value: 'Module' }));

const $$Astro$B = createAstro("https://griffinswebservices.com");
const $$FilteredPortfolioVariant = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$B, $$props, $$slots);
  Astro2.self = $$FilteredPortfolioVariant;
  const {
    items = [],
    title,
    heading: headingValue,
  ...
  const filterItems = toArray(items);
  const relatedItems = await getPublishedCollection(relatedCollection);
  ...
  function matchesFilter(relatedItem, filterKey) {
  ...
  async function optimizeItemImage(item) {
    ...
    if (!metadata) {
      return { data: { ...item, alt: altText }, mediaEntry: void 0 };
    }
  ...
  const validGroups = groups.filter((group) => group.count > 0).sort((a, b) => a.order - b.order);
  const totalItems = validGroups.reduce((sum, g) => sum + g.count, 0);
  const sectionTitle = collectionTitle ?? title;
  const showHeader = Boolean(sectionTitle || headingValue || description);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative overflow-hidden ${className}`.trim() }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class=""> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": headingValue, "description": description, "className": `text-center inner-section ${headingSectionClassName}`.trim(), "headingClassName": "h2 mb-6 heading-padding", "descriptionClassName": "large-text max-w-2xl mx-auto" })}`} ${validGroups.length > 0 && renderTemplate`${renderComponent($$result2, "FilteredPortfolioCarousel", FilteredPortfolioCarousel, { "client:visible": true, "groups": validGroups, "filter": filter, "filterSize": filterSize, "filterClassName": filterClassName, "showFilters": showFilters, "showArrows": showArrows, "drag": drag, "className": showHeader ? "mt-12" : "", "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/Portfolio/FilteredPortfolioCarousel", "client:component-export": "default" })}`} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, totalItems) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": async ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/FilteredPortfolioVariant.astro", void 0);

const $$file$l = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/FilteredPortfolioVariant.astro";
const $$url$l = undefined;

const __vite_glob_0_10 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$FilteredPortfolioVariant,
  file: $$file$l,
  url: $$url$l
}, Symbol.toStringTag, { value: 'Module' }));

const $$Astro$A = createAstro("https://griffinswebservices.com");
const $$GridVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `py-16 ${className}` }, { "default": ($$result2) => renderTemplate`${(title || description) && renderTemplate`${maybeRenderHead()}<div class="text-center mb-12"> ${title && renderTemplate`<h2 class="text-4xl text-heading font-bold mb-4">${title}</h2>`} ${description && renderTemplate`<p class="text-lg text-text max-w-2xl mx-auto">${description}</p>`} </div>`}${safeItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} ${gapClasses[gap]} list-none`, "class")}> ${safeItems.map((item) => renderTemplate`<li> ${renderComponent($$result2, "FeatureCard", FeatureCard, { "client:visible": true, "data": item, "ringDuration": getRingDuration(item), "className": getCardClassName(item), "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/FeatureCard", "client:component-export": "default" })} </li>`)} </ul>`}${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "primary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`}` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/GridVariant.astro", void 0);

const $$file$k = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/GridVariant.astro";
...
const $$Astro$z = createAstro("https://griffinswebservices.com");
const $$HeroChecklistVariant = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$z, $$props, $$slots);
  Astro2.self = $$HeroChecklistVariant;
  const {
    items = [],
    title,
    heading,
  ...
  const showHeader = Boolean(title || heading || description);
  return renderTemplate`${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<div${addAttribute(id, "id")}${addAttribute(className, "class")}>${showHeader && renderTemplate`${renderComponent($$result, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": "text-section mb-6" })}`}<ul${addAttribute(`grid ${columnClasses[columns]} gap-2 lg:gap-3 list-none ${listClassName}`.trim(), "class")}>${safeItems.map((item) => renderTemplate`<li class="list-none flex items-start gap-2"><span class="faded-bg p-1.5 rounded-full flex items-center justify-center text-accent flex-shrink-0 mt-0.5"><svg class="w-3 h-3 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg></span><div class="flex flex-col"><span class="text-text text-base lg:text-lg leading-relaxed font-medium">${item.title}</span>${showDescription && item.description && renderTemplate`<span class="text-muted text-sm mt-0.5">${item.description}</span>`}</div></li>`)}</ul></div>`}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/HeroChecklistVariant.astro", void 0);

const $$file$j = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/HeroChecklistVariant.astro";
const $$url$j = undefined;

const __vite_glob_0_12 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$HeroChecklistVariant,
  file: $$file$j,
  url: $$url$j
}, Symbol.toStringTag, { value: 'Module' }));
...
const $$IconListVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `py-16 ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto inner-section"> <div${addAttribute(`flex flex-col lg:space-x-15 ${showHeader ? "lg:flex-row lg:items-start" : ""}`.trim(), "class")}> ${showHeader && renderTemplate`<div class="w-full min-w-0 lg:w-1/2 sticky-section lg:self-start"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": heading, "description": description, "className": "space-y-2 text-left w-full", "headingTag": headingTag, "headingClassName": headingClassName, "descriptionClassName": "large-text leading-relaxed", "titleVisibleRootMargin": 0 })} ${Astro2.slots.has("under-text") && renderTemplate`<div class="mt-8"> ${renderSlot($$result2, $$slots["under-text"])} </div>`} </div>`} ${safeItems.length > 0 && renderTemplate`<div${addAttribute(`w-full min-w-0 py-6 lg:py-0 ${showHeader ? "lg:w-1/2" : ""}`.trim(), "class")}> <ul${addAttribute(`flex flex-col gap-4 list-none`.trim(), "class")}> ${safeItems.map((item) => renderTemplate`<li class="relative overflow-hidden" data-animate="fade-in-up" data-animate-threshold="0.15" data-animate-root-margin="-10% 0px -10% 0px"> ${item.url ? renderTemplate`${renderComponent($$result2, "FeatureCard", FeatureCard, { "client:visible": true, "data": item, "ringDuration": 800, "listItemProps": {
    layout: itemLayout,
    alignment: "left",
  ...
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/FeatureCard", "client:component-export": "default" })}` : renderTemplate`${renderComponent($$result2, "IconListItem", IconListItem, { "data": item, "layout": itemLayout, "alignment": "left", "className": "text-left gap-1 w-full flex items-start", "iconClassName": "icon-large card-icon-color mr-4", "iconSize": "xl", "titleTag": "h3", "titleClassName": "text-heading h3 my-4", "descriptionClassName": "text-lg text-text" })}`} </li>`)} </ul> </div>`} </div> ${hasSlotContent && renderTemplate`<div${addAttribute(`mt-8 ${slotContainerClassName}`.trim(), "class")}> ${renderSlot($$result2, $$slots["default"])} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/IconListVariant.astro", void 0);

const $$file$i = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/IconListVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/LinkTreeVariant.astro", void 0);

const $$file$h = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/LinkTreeVariant.astro";
...
const $$ListCardVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`<div class="heading-padding"> ${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description })} </div>`} ${renderComponent($$result2, "CardRenderer", CardRenderer, { "client:visible": true, "items": safeItems, "columns": 1, "className": gridMarginClass, "featureCardProps": featureCardProps, "disableStagger": true, "animation": {
    type: (index) => index % 2 === 0 ? "fade-in-left" : "fade-in-right",
    once: true
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/CardRenderer", "client:component-export": "default" })} ${showCTA && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ListCardVariant.astro", void 0);

const $$file$g = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ListCardVariant.astro";
...
const $$ListVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const safeItems = toArray(items);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `${className}` }, { "default": ($$result2) => renderTemplate`${showHeadingSection && (title || description) && renderTemplate`${renderComponent($$result2, "DividerHeading", DividerHeading, { "title": title, "showDivider": false, "className": "mb-4", "headingClassName": "h4 text-heading" })}`}${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<nav class="flex flex-col gap-2 list-none"${addAttribute(title ? `${title} links` : void 0, "aria-label")}> ${safeItems.map((item) => renderTemplate`${renderComponent($$result2, "Button", Button, { "href": item.url, "className": "text-text", "variant": "link" }, { "default": ($$result3) => renderTemplate`${item.title}` })}`)} </nav>`}${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="mt-12"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "variant": "tertiary" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}<svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path> </svg> ` })} </div>`}` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ListVariant.astro", void 0);

const $$file$f = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ListVariant.astro";
...
const $$MasonryVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `py-16 ${className}` }, { "default": ($$result2) => renderTemplate`${(title || description) && renderTemplate`${maybeRenderHead()}<div class="text-center mb-12"> ${title && renderTemplate`<h2 class="text-4xl text-heading font-bold mb-4">${title}</h2>`} ${description && renderTemplate`<p class="text-lg text-text max-w-2xl mx-auto">${description}</p>`} </div>`}${safeItems.length > 0 && renderTemplate`<ul class="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-6 list-none"> ${safeItems.map(
    (item) => item && renderTemplate`<li class="inline-block w-full"> ${renderComponent($$result2, "FeatureCard", FeatureCard, { "client:visible": true, "data": item, "ringDuration": getRingDuration(item), "className": getCardClassName(item), "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/FeatureCard", "client:component-export": "default" })} </li>`
  )} </ul>`}${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "primary", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`}` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/MasonryVariant.astro", void 0);

const $$file$e = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/MasonryVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/LoopTemplates/Menu/MenuDropdown.astro", void 0);
...
const $$MenuItem = createComponent(($$result, $$props, $$slots) => {
  ...
  `;
  return renderTemplate`${maybeRenderHead()}<li${addAttribute(`relative ${hasChildren ? "menu-item" : ""}`, "class")}> ${isToggleOnly ? renderTemplate`<button type="button"${addAttribute(`${linkClasses.trim()} cursor-pointer`, "class")} aria-expanded="false" aria-haspopup="menu"${addAttribute(description, "title")}> ${icon && renderTemplate`<span class="icon">${icon}</span>`} <span>${title}</span> <svg class="w-4 h-4 transition-transform menu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path> </svg> </button>` : renderTemplate`<a${addAttribute(url || "#", "href")}${addAttribute(openInNewTab ? "_blank" : void 0, "target")}${addAttribute(openInNewTab ? "noopener noreferrer" : void 0, "rel")}${addAttribute(linkClasses.trim(), "class")}${addAttribute(isActive ? "page" : void 0, "aria-current")}${addAttribute(hasChildren ? "menu" : void 0, "aria-haspopup")}${addAttribute(description, "title")}> ${icon && renderTemplate`<span class="icon">${icon}</span>`} <span>${title}</span> ${hasChildren && renderTemplate`<svg class="w-4 h-4 transition-transform menu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path> </svg>`} </a>`} ${hasChildren && renderTemplate`${renderComponent($$result, "MenuDropdown", $$MenuDropdown, { "items": children, "level": level + 1, "parentSlug": slug })}`} </li>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/LoopComponents/Menu/MenuItem.astro", void 0);
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/LoopTemplates/Menu/MenuList.astro", void 0);
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    ...
    /* @__PURE__ */ jsx(
      Modal$1,
      {
        ...
        position: "center",
        className: `w-full max-w-full h-full bg-gradient p-0 rounded-none transform transition-transform duration-300 ease-out ${isOpen ? "translate-y-0" : "translate-y-full"}`,
        ...
        children: /* @__PURE__ */ jsx(
          "nav",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "mobile-menu-content inner-section my-auto py-4", children: /* @__PURE__ */ jsx("div", { className: "relative w-full h-full overflow-hidden flex justify-left lg:justify-center", children: /* @__PURE__ */ jsx(
              "div",
              {
...
const $$MenuVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav${addAttribute(id, "id")} role="navigation" aria-label="Main navigation"${addAttribute(`menu-variant ${className}`, "class")}> ${showDesktop && renderTemplate`<div${addAttribute(`menu-desktop ${desktopClasses}`, "class")}> ${renderComponent($$result, "MenuList", $$MenuList, { "items": menuTree, "level": 0 })} </div>`} ${showMobile && renderTemplate`<div${addAttribute(`menu-mobile ${mobileClasses}`, "class")}> ${renderComponent($$result, "HamburgerMenuDrawer", MobileMenuDrawer, { "client:hover": true, "items": menuTree, "className": "menu-mobile-inner", "closeButton": closeButton, "hamburgerTransform": hamburgerTransform, "client:component-hydration": "hover", "client:component-path": "@/components/LoopTemplates/Menu/HamburgerMenu/HamburgerMenuDrawer", "client:component-export": "default" })} </div>`} </nav>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/MenuVariant.astro", void 0);

const $$file$d = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/MenuVariant.astro";
...
function ChildCard({
  ...
  const defaultIconClassName = hasChildren ? "icon-large z-10 card-icon-color" : resolvedLayout.includes("horizontal") ? "icon-large z-10 card-icon-color mx-auto" : "icon-large z-10 mb-5 card-icon-color mx-auto";
  const listItemConfig = {
    ...
    descriptionClassName: descriptionClassName ?? (hasChildren ? "text-text leading-relaxed relative z-10 mt-4" : "text-text leading-relaxed relative z-10"),
    descriptionTag: descriptionTag ?? "p",
    // Add gap between icon and title for horizontal-stacked
    containerClassName: hasChildren ? "gap-3" : void 0,
    ...restListItemProps
  };
  const listItemData = {};
  if (hasContent(resolvedIcon)) listItemData.icon = resolvedIcon;
  ...
  const innerCardClass = hasChildren ? "mx-auto px-6 md:px-10 py-8 flex flex-col justify-start items-start relative card-bg" : "min-h-90 mx-auto px-6 md:px-10 py-8 flex flex-col justify-center items-center relative card-bg";
  ...
  return /* @__PURE__ */ jsx("div", { className, children: /* @__PURE__ */ jsxs(
    AnimatedBorder,
    {
      ...
      linkProps: isInteractive ? { href: resolvedUrl } : void 0,
      children: [
        ...
        hasChildren && /* @__PURE__ */ jsx("ul", { className: "mt-6 pt-5 border-t border-primary/15 space-y-2.5 relative z-10 list-none w-full text-left", children: resolvedChildItems.map((child, index) => /* @__PURE__ */ jsxs("li", { className: "list-none flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "faded-bg p-1.5 rounded-full flex items-center justify-center text-accent flex-shrink-0", children: child.icon ? /* @__PURE__ */ jsx(Icon, { icon: child.icon, size: "sm", className: "w-3 h-3 lg:w-4 lg:h-4" }) : /* @__PURE__ */ jsx(
            "svg",
            {
          ...
          /* @__PURE__ */ jsx("span", { className: "text-text text-base leading-relaxed", children: child.title })
        ] }, index)) })
      ]
    }
  ) });
...
const $$Astro$p = createAstro("https://griffinswebservices.com");
const $$NestedCardVariant = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$p, $$props, $$slots);
  Astro2.self = $$NestedCardVariant;
  const {
    items = [],
    title,
    heading,
  ...
  const maxColumns = columns === "auto" ? 3 : columns;
  const effectiveColumns = Math.min(maxColumns, safeItems.length || 1);
  const collectionFromUrl = collectionUrl?.replace(/^\//, "");
  ...
  const cardItems = await Promise.all(
    safeItems.map(async (item) => {
      ...
      if (targetCollection && itemSlug) {
        ...
        childItems = childEntries.map((child) => ({
  ...
  const showHeader = Boolean(title || heading || description);
  return renderTemplate`${safeItems.length > 0 && renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `relative overflow-hidden ${className}`.trim() }, { "default": async ($$result2) => renderTemplate`${maybeRenderHead()}<div class="inner-section">${showHeader && renderTemplate`<div class="heading-padding">${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description })}</div>`}${renderComponent($$result2, "ChildCardRenderer", ChildCardRenderer, { "client:visible": true, "items": cardItems, "columns": effectiveColumns, "className": showHeader ? "mt-12" : "", "animation": {
    once: false,
    threshold: 0.15,
    rootMargin: "-10% 0px -10% 0px"
  }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/ChildCardRenderer", "client:component-export": "default" })}</div>` })}`}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/NestedCardVariant.astro", void 0);

const $$file$c = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/NestedCardVariant.astro";
const $$url$c = undefined;

const __vite_glob_0_19 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$NestedCardVariant,
  file: $$file$c,
  url: $$url$c
}, Symbol.toStringTag, { value: 'Module' }));
...
const $$PainPointsVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section bg-bg2 relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": headingValue, "description": description })}`} ${safeItems.length > 0 && renderTemplate`<div${addAttribute(`${layoutClasses[layout]} mt-10`, "class")}> ${safeItems.map((item, index) => {
  ...
  })} </div>`} ${showButtonSection && ctaHref && ctaText && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref, "rightIcon": "lu:arrow-right", "variant": "primary" }, { "default": ($$result3) => renderTemplate`${ctaText}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PainPointsVariant.astro", void 0);

const $$file$b = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PainPointsVariant.astro";
...
const $$PortfolioScreenVariant = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const SIZES = "(max-width: 640px) calc(100vw - 48px), (max-width: 1024px) min(calc(100vw - 48px), 850px), 850px";
  ...
  const heightClasses = size === "large" ? "h-[420px] sm:h-[520px] lg:h-[600px]" : "h-[420px] sm:h-[520px] lg:h-[450px]";
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(id, "id")}${addAttribute(`relative overflow-hidden z-10 ${className} ${visibilityClasses}`.trim(), "class")} data-astro-cid-2a4yv3bx> <div${addAttribute(`relative w-full max-w-[920px] mx-auto ${heightClasses}`, "class")} data-astro-cid-2a4yv3bx> <div class="relative h-full top-0 rounded-lg" data-astro-cid-2a4yv3bx> <!-- ComputerScreen wrapper with client carousel inside --> ${renderComponent($$result, "ComputerScreen", $$ComputerScreen, { "data-astro-cid-2a4yv3bx": true }, { "default": async ($$result2) => renderTemplate` <div class="relative h-full bottom-image-fade" data-portfolio-container data-astro-cid-2a4yv3bx> <!-- SSR placeholder image - always shows to prevent blank screen while carousel hydrates --> ${firstMedia && renderTemplate`<figure class="absolute inset-0 pointer-events-none overflow-hidden bg-black/40 z-0" data-ssr-placeholder data-astro-cid-2a4yv3bx> <picture data-astro-cid-2a4yv3bx> ${firstMedia.sources?.map((source) => renderTemplate`<source${addAttribute(source.type, "type")}${addAttribute(source.srcSet, "srcset")}${addAttribute(source.sizes || firstMedia.sizes, "sizes")} data-astro-cid-2a4yv3bx>`)} <img${addAttribute(firstMedia.src, "src")}${addAttribute(firstMedia.srcSet, "srcset")}${addAttribute(firstMedia.sizes, "sizes")}${addAttribute(
    firstMedia.alt || firstItem?.title || "Project preview",
    "alt"
  )}${addAttribute(firstMedia.width, "width")}${addAttribute(firstMedia.height, "height")}${addAttribute(shouldEagerLoad ? "eager" : "lazy", "loading")}${addAttribute(shouldEagerLoad ? "sync" : "async", "decoding")}${addAttribute(shouldEagerLoad ? "high" : "auto", "fetchpriority")}${addAttribute(false, "draggable")} class="block h-auto min-h-full w-full select-none object-cover object-top" data-astro-cid-2a4yv3bx> </picture> </figure>`} <!-- Client carousel loads here - sits on top with z-10 --> <div class="relative z-10 h-full" data-astro-cid-2a4yv3bx> ${mediaQuery ? renderTemplate`${renderComponent($$result2, "PortfolioScreenShowcase", PortfolioScreenShowcase, { "client:media": mediaQuery, ...showcaseProps, "client:component-hydration": "media", "client:component-path": "@/components/LoopTemplates/Portfolio/PortfolioScreenShowcase", "client:component-export": "default", "data-astro-cid-2a4yv3bx": true })}` : renderTemplate`${renderComponent($$result2, "PortfolioScreenShowcase", PortfolioScreenShowcase, { "client:visible": true, ...showcaseProps, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/Portfolio/PortfolioScreenShowcase", "client:component-export": "default", "data-astro-cid-2a4yv3bx": true })}`} </div> </div> ` })} </div> </div> </div> `;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PortfolioScreenVariant.astro", void 0);

const $$file$a = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PortfolioScreenVariant.astro";
...
const $$PortfolioVariant = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const sectionTitle = collectionTitle ?? title;
  const showHeader = Boolean(sectionTitle || headingValue || description);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative overflow-hidden ${className}`.trim() }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class=""> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": headingValue, "description": description, "className": "text-center", "headingClassName": "h2 mb-6 heading-padding", "descriptionClassName": "large-text max-w-2xl mx-auto" })}`} ${portfolioItems.length > 0 && renderTemplate`${renderComponent($$result2, "PortfolioCarousel", PortfolioCarousel, { "client:visible": true, "items": portfolioItems, "mediaEntries": mediaEntries, "autoplay": autoplay, "autoAdvanceDelay": autoAdvanceDelay, "className": showHeader ? "mt-12" : "", "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/Portfolio/PortfolioCarousel", "client:component-export": "default" })}`} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, portfolioItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": async ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PortfolioVariant.astro", void 0);

const $$file$9 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/PortfolioVariant.astro";
...
const $$ProofPointsVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<ul${addAttribute(id, "id")}${addAttribute(listClass, "class")}>${safeItems.map((item) => {
    ...
    return renderTemplate`<li class="flex items-start gap-2 text-base leading-relaxed text-text"><span class="shrink-0" aria-hidden="true">${renderComponent($$result, "Image", $$Image, { "src": LogoPoster, "alt": "", "widths": [32], "heights": [32], "sizes": "32px", "class": "w-6 h-6 rounded-full object-contain border border-accent/30 card-bg" })}</span><span class="text-muted text-sm leading-snug block">${rendered}</span></li>`;
  })}</ul>`}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ProofPointsVariant.astro", void 0);

const $$file$8 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/ProofPointsVariant.astro";
...
const $$QuickFactsVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<div${addAttribute(id, "id")}${addAttribute(combinedClass, "class")}>${safeItems.map((item) => {
    const record = item && typeof item === "object" && "data" in item ? item.data ?? item : item ?? {};
    return renderTemplate`<div class="p-3 rounded-2xl card-bg space-y-1"><p class="text-xs uppercase tracking-[0.2em] text-muted">${record.title ?? record.label}</p><p class="text-sm text-heading font-semibold">${record.description ?? record.value}</p></div>`;
  })}</div>`}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/QuickFactsVariant.astro", void 0);

const $$file$7 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/QuickFactsVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/SocialMediaVariant.astro", void 0);

const $$file$6 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/SocialMediaVariant.astro";
...
const $$Astro$h = createAstro("https://griffinswebservices.com");
const $$SplitHighlightsVariant = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$h, $$props, $$slots);
  Astro2.self = $$SplitHighlightsVariant;
  const {
    items = [],
    title,
    heading,
  ...
  const showTopRegion = showHeader || hasDescription;
  const columnClasses = {
    1: "grid-cols-1",
    2: "grid-cols-1 md:grid-cols-2",
    3: "grid-cols-1 md:grid-cols-2 lg:grid-cols-3",
  ...
  const getItemTitle = (record) => pickString(record, ["title", "heading", "name"]);
  const getItemDescription = (record) => pickString(record, ["description", "summary", "body", "text"]);
  const getItemEyebrow = (record) => pickString(record, ["eyebrow", "tagline", "label", "before"]);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section space-y-16"> ${showTopRegion && renderTemplate`<div class="grid gap-10 lg:gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)]"> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": heading, "className": "space-y-4 text-left", "headingClassName": "h2 text-4xl lg:text-5xl leading-tight", "titleVisibleRootMargin": 0 })}`} ${hasDescription && renderTemplate`<div class="text-lg text-muted leading-relaxed space-y-5"> <p>${description}</p> </div>`} </div>`} ${safeItems.length > 0 && renderTemplate`<div${addAttribute(`grid gap-6 ${gridClass}`.trim(), "class")}> ${safeItems.map((item, index) => {
    ...
    return renderTemplate`<article${addAttribute(key, "key")} class="relative overflow-hidden rounded-3xl border border-white/10 card-bg p-6 lg:p-8 shadow-2xl" data-animate="fade-in-up" data-animate-directional="true"${addAttribute(staggerDelay, "data-animate-delay")}> ${eyebrow && renderTemplate`<p class="text-xs uppercase tracking-[0.3em] text-accent font-semibold mb-3"> ${eyebrow} </p>`} ${itemTitle && renderTemplate`<h3 class="text-xl lg:text-2xl text-heading font-semibold">${itemTitle}</h3>`} ${itemDescription && renderTemplate`<p class="mt-3 text-base text-muted leading-relaxed"> ${itemDescription} </p>`} </article>`;
  })} </div>`} ${showCTA && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/SplitHighlightsVariant.astro", void 0);

const $$file$5 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/SplitHighlightsVariant.astro";
const $$url$5 = undefined;

const __vite_glob_0_26 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$SplitHighlightsVariant,
  file: $$file$5,
  url: $$url$5
}, Symbol.toStringTag, { value: 'Module' }));
...
const $$StatCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(cardClasses, "class")}> <!-- Animated border effect via CSS --> <div class="absolute inset-0 rounded-2xl card-bg transition-colors duration-300 pointer-events-none"></div> <p class="text-heading text-4xl font-bold"> ${shouldAnimate && typeof value === "number" ? renderTemplate`${renderComponent($$result, "Counter", $$Counter, { "start": startValue, "end": value, "decimals": decimalPlaces, "prefix": prefix, "suffix": suffix, "class": "leading-none" })}` : fallbackText || "\u2014"} </p> ${title && renderTemplate`<p class="text-muted text-sm uppercase tracking-[0.35em] mt-2"> ${title} </p>`} ${description && renderTemplate`<p class="text-muted text-sm leading-relaxed mt-3"> ${description} </p>`} </div>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/LoopComponents/StatCard.astro", void 0);
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/StatsVariant.astro", void 0);

const $$file$4 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/StatsVariant.astro";
...
const $$TechnologiesVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const safeItems = toArray(items);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate`  ${safeItems.length > 0 && renderTemplate`${renderComponent($$result2, "TechStackSection", TechStackSection, { "client:visible": true, "technologies": safeItems, "eyebrow": collectionTitle ?? title, "title": title ?? collectionTitle, "description": description, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/TechStackSection", "client:component-export": "default" })}`}` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TechnologiesVariant.astro", void 0);

const $$file$3 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TechnologiesVariant.astro";
...
const Placeholder = new Proxy({"src":"/assets/placeholder-D97sUwgC.jpg","width":8576,"height":5696,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/assets/placeholder.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/assets/placeholder.jpg");
							return target[name];
						}
					});
...
const $$TestimonialCirclesVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$7 || (_a$7 = __template$7(["", "<a", "", "", "", '> <div class="flex justify-center items-center"> ', ' </div> <div class="flex flex-col items-start"> <span', ' role="heading" aria-level="3"> ', ' </span> <p class="small-text m-0 capitalize"> ', ' </p> </div> </a> <script>\n  (function() {\n    if (window.__testimonialsPulseInitialized) return;\n    window.__testimonialsPulseInitialized = true;\n\n    const initTestimonialsPulse = () => {\n      const circles = document.querySelectorAll(".testimonials .circle");\n      if (!circles.length) return;\n\n      let idx = 0;\n      const pulse = () => {\n        const prev = (idx - 1 + circles.length) % circles.length;\n        circles[prev]?.classList.remove("heartbeat");\n        circles[idx]?.classList.add("heartbeat");\n        idx = (idx + 1) % circles.length;\n      };\n\n      pulse();\n      setInterval(pulse, 1600);\n    };\n\n    if ("requestIdleCallback" in window) {\n      requestIdleCallback(initTestimonialsPulse);\n    } else {\n      window.addEventListener("load", initTestimonialsPulse, { once: true });\n    }\n  })();\n<\/script>'])), maybeRenderHead(), addAttribute(id, "id"), addAttribute(link, "href"), addAttribute(`testimonials flex items-center gap-4 lg:gap-5 px-2 md:px-0 ${className}`.trim(), "class"), addAttribute(`${counterLabel} - View testimonials`, "aria-label"), faces.map((face) => renderTemplate`<div class="circle -mr-2 lg:-mr-4 first:ml-0 w-11 h-11 sm:w-12 sm:h-12 lg:w-13 lg:h-13 rounded-full overflow-hidden shrink-0 flex items-center justify-center"> ${(() => {
  ...
  })()} </div>`), addAttribute(`${counterClassName} capitalize`, "class"), renderComponent($$result, "Counter", $$Counter, { "prefix": counterPrefix, "start": counterStart, "end": counterEnd, "duration": counterDuration, "decimals": counterDecimals, "suffix": counterSuffix, "class": "leading-none" }), counterLabel);
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialCirclesVariant.astro", void 0);

const $$file$2 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialCirclesVariant.astro";
...
const $$Astro$c = createAstro("https://griffinswebservices.com");
const $$TestimonialGridVariant = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$c, $$props, $$slots);
  Astro2.self = $$TestimonialGridVariant;
  const {
    items = [],
    title,
    heading,
  ...
  const getRingDuration = (item) => typeof item?.ringDuration === "number" ? item.ringDuration : 800;
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${(title || collectionTitle || description || heading) && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "className": "text-section", "headingClassName": "mb-6", "descriptionClassName": "large-text" })}`} ${safeItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} ${gapClasses[gap]} list-none`, "class")}> ${safeItems.map((item) => renderTemplate`<li> ${renderComponent($$result2, "TestimonialCard", TestimonialCard, { "item": item, "ringDuration": getRingDuration(item), "className": "h-full" })} </li>`)} </ul>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialGridVariant.astro", void 0);

const $$file$1 = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialGridVariant.astro";
const $$url$1 = undefined;

const __vite_glob_0_31 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$TestimonialGridVariant,
  file: $$file$1,
  url: $$url$1
}, Symbol.toStringTag, { value: 'Module' }));

const $$Astro$b = createAstro("https://griffinswebservices.com");
const $$TwoColumnImageVariant = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$b, $$props, $$slots);
  ...
  const safeItems = contentType === "text" ? await Promise.all(
    rawItems.map(async (item) => {
      if (item.Content || item.rendered?.Content) return item;
      if (item.render) {
        try {
          const { Content } = await item.render();
          return { ...item, Content };
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section ${bgClass} relative ${className}`.trim() }, { "default": async ($$result2) => renderTemplate`${borderClass && renderTemplate`${maybeRenderHead()}<div${addAttribute(borderClass, "class")}></div>`}<div class="inner-section"> <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">  <div${addAttribute(`lg:flex-1 w-full ${stickyImage ? "sticky-section" : ""} ${imageOrderClass} ${imageClassName}`.trim(), "class")}> <div class="aspect-5/3 rounded-3xl bg-muted/10 border border-muted/20 flex items-center justify-center overflow-hidden"> ${hasSlotContent ? renderTemplate`${renderSlot($$result2, $$slots["default"])}` : imageSrc ? renderTemplate`<img${addAttribute(imageSrc, "src")}${addAttribute(imageAlt, "alt")} class="w-full h-full object-cover rounded-3xl">` : renderTemplate`<div class="text-center p-8"> <div class="w-16 h-16 mx-auto mb-4 rounded-full bg-accent/10 flex items-center justify-center"> <span class="text-accent text-2xl">${imagePlaceholder}</span> </div> <p class="text-muted text-sm">${imageAlt}</p> </div>`} </div> </div>  <div${addAttribute(`lg:flex-1 space-y-8 ${contentOrderClass} ${contentClassName}`.trim(), "class")}> ${showHeader && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": "text-left" })}`}  ${hasItems && contentType === "checklist" && renderTemplate`<ul class="grid grid-cols-1 gap-5 list-none"> ${safeItems.map((item) => {
    ...
    return renderTemplate`<li> ${renderComponent($$result2, "IconListItem", IconListItem, { "data": {
      icon: itemIcon,
      title: itemTitle,
    ...
    return Content ? renderTemplate`<div class="[&>p]:text-muted [&>p]:text-lg [&>p]:leading-relaxed [&>strong]:text-heading [&>blockquote]:blockquote-gradient-line [&>blockquote]:italic [&>blockquote]:text-heading [&>blockquote]:font-medium [&>blockquote]:text-xl">${renderComponent($$result2, "Content", Content, {})}</div>` : renderTemplate`<p>${unescapeHTML(itemText)}</p>`;
  })} </div>`}  ${showCTA && renderTemplate`<div class="mt-8"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": async ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> </div> </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TwoColumnImageVariant.astro", void 0);

const $$file = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TwoColumnImageVariant.astro";
const $$url = undefined;
...
async function getVariantComponents() {
  const variants = /* #__PURE__ */ Object.assign({"../AccordionVariant.astro": __vite_glob_0_0$2,"../BenefitsInlineVariant.astro": __vite_glob_0_1$1,"../BenefitsVariant.astro": __vite_glob_0_2$1,"../BlogVariant.astro": __vite_glob_0_3,"../CardVariant.astro": __vite_glob_0_4,"../ChecklistVariant.astro": __vite_glob_0_5,"../ComparisonVariant.astro": __vite_glob_0_6,"../ContactListVariant.astro": __vite_glob_0_7,"../ContactVariant.astro": __vite_glob_0_8,"../FilteredCardVariant.astro": __vite_glob_0_9,"../FilteredPortfolioVariant.astro": __vite_glob_0_10,"../GridVariant.astro": __vite_glob_0_11,"../HeroChecklistVariant.astro": __vite_glob_0_12,"../IconListVariant.astro": __vite_glob_0_13,"../LinkTreeVariant.astro": __vite_glob_0_14,"../ListCardVariant.astro": __vite_glob_0_15,"../ListVariant.astro": __vite_glob_0_16,"../MasonryVariant.astro": __vite_glob_0_17,"../MenuVariant.astro": __vite_glob_0_18,"../NestedCardVariant.astro": __vite_glob_0_19,"../PainPointsVariant.astro": __vite_glob_0_20,"../PortfolioScreenVariant.astro": __vite_glob_0_21,"../PortfolioVariant.astro": __vite_glob_0_22,"../ProofPointsVariant.astro": __vite_glob_0_23,"../QuickFactsVariant.astro": __vite_glob_0_24,"../SocialMediaVariant.astro": __vite_glob_0_25,"../SplitHighlightsVariant.astro": __vite_glob_0_26,"../StatsVariant.astro": __vite_glob_0_27,"../TechnologiesVariant.astro": __vite_glob_0_28,"../TestimonialCarouselVariant.astro": __vite_glob_0_29,"../TestimonialCirclesVariant.astro": __vite_glob_0_30,"../TestimonialGridVariant.astro": __vite_glob_0_31,"../TwoColumnImageVariant.astro": __vite_glob_0_32,"../VideoAccordionVariant.astro": __vite_glob_0_33});
...
function shouldItemHavePage(item, meta, parentItem) {
...
const $$ContentRenderer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const hasSlotContent = Astro2.slots?.has("default") || Astro2.slots?.has("under-text") || Astro2.slots?.has("under-button");
  if (items.length === 0 && !hasSlotContent) {
    return;
  }
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/ContentRenderer.astro", void 0);
...
function OptimizedLottie({
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      ref: containerRef,
      "aria-label": decorative ? void 0 : alt,
      ...
      children: [
        ...
        shouldLoadLottie && !motionDisabled && /* @__PURE__ */ jsx(
          "div",
          {
...
function LottieLogo({
  ...
  const accessibilityProps = decorative ? { "aria-hidden": true, role: "presentation" } : { "aria-label": alt };
  if (shouldDisableMotion) {
    return /* @__PURE__ */ jsx("div", { className: `${className} relative ${mediaClasses}`, ...accessibilityProps, children });
  }
  return /* @__PURE__ */ jsx(
    OptimizedLottie,
    {
...
const $$Astro$9 = createAstro("https://griffinswebservices.com");
const $$TextLogoStatic = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(className, "class")}${addAttribute(animateOutText ? "true" : void 0, "data-scroll-fade-css")}${spreadAttributes(headingAttrs)} data-astro-cid-rqc5q4ws> <span${addAttribute(firstClass, "class")} style="line-height: normal;" data-astro-cid-rqc5q4ws> ${firstWord} </span> ${restOfTitle && renderTemplate`<span${addAttribute(restClass, "class")} style="line-height: normal;" data-astro-cid-rqc5q4ws> ${" "}${restOfTitle} </span>`} </div>  ${renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Logo/TextLogoStatic.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Logo/TextLogoStatic.astro", void 0);

const $$Astro$8 = createAstro("https://griffinswebservices.com");
const $$Logo = createComponent(($$result, $$props, $$slots) => {
  ...
  const alt = altContext ? `Griffin's Web Services Logo - ${altContext}` : "Griffin's Web Services Logo";
  ...
  return renderTemplate`${maybeRenderHead()}<a href="/" translate="no"${addAttribute(`notranslate flex justify-center items-center gap-1.5 ${className}`, "class")}> ${shouldUseLottie ? renderTemplate`${renderComponent($$result, "LottieLogo", LottieLogo, { "alt": alt, "loading": loading, "trigger": trigger, "className": "logo-class", "mediaClasses": logoClasses, "loop": loop, "client:scroll": true, "client:component-hydration": "scroll", "client:component-path": "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Logo/LottieLogo", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Image", $$Image, { "src": POSTER_SRC, "alt": "", "loading": loading, "decoding": "async", "class": logoClasses, "widths": LOGO_WIDTHS, "sizes": LOGO_SIZES, "fetchpriority": loading === "eager" ? "high" : "low", "aria-hidden": "true" })} ` })}` : renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": POSTER_SRC, "alt": alt, "loading": loading, "decoding": "async", "class": logoClasses, "widths": LOGO_WIDTHS, "sizes": LOGO_SIZES, "fetchpriority": loading === "eager" ? "high" : void 0 })}`} <div> ${renderComponent($$result, "TextLogoStatic", $$TextLogoStatic, { "title": siteData.title, "className": "flex flex-col p-0 m-0", "fadeDuration": textFadeMs, "animateOutText": animateOutText, "firstClass": titleFirstClass, "restClass": titleRestClass })} </div> </a>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/Logo/Logo.astro", void 0);
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex max-h-64 flex-col overflow-y-auto", children: supportedLanguages.map((language) => {
          ...
          return /* @__PURE__ */ jsxs(
            ...
            {
              type: "button",
              className: `flex items-center gap-3 rounded-xl px-3 py-2 text-sm transition ${isActive ? "bg-primary/20 text-primary font-semibold" : "hover:bg-primary-light/5 text-text"} ${isDisabled ? "cursor-not-allowed opacity-60" : ""}`,
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative contents", children: [
    /* @__PURE__ */ jsx(
      CircleCheckbox,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-sm sm:text-xl leading-none", "aria-hidden": "true", children: currentLanguage.flag || "🌐" }) })
      }
    ),
    open && /* @__PURE__ */ jsx(
      LanguageDropdown,
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="fixed w-full top-0 z-[100000]" role="banner" aria-label="Primary site header"> <div class="relative flex items-center justify-between head-foot-section py-2 gap-4"> <!-- Logo --> ${renderComponent($$result, "Logo", $$Logo, { "loading": "eager", "trigger": "scroll", "animateOutText": true, "altContext": "Home" })} ${renderComponent($$result, "ThemeControls", ThemeControls, { "className": "hidden lg:flex", "client:hover": true, "client:component-hydration": "hover", "client:component-path": "@/components/ThemeControls/ThemeControls.jsx", "client:component-export": "default" })} <div class="flex items-center gap-4"> ${renderComponent($$result, "ThemeControls", ThemeControls, { "className": "lg:hidden", "client:hover": true, "client:component-hydration": "hover", "client:component-path": "@/components/ThemeControls/ThemeControls.jsx", "client:component-export": "default" })} <nav class="flex items-center justify-center sm:gap-4" aria-label="Primary navigation" role="navigation"> <!-- Navigation Menu using query --> ${renderComponent($$result, "ContentRenderer", $$ContentRenderer, { "query": related("menu-items", "menu", "main-menu"), "variant": "MenuVariant", "mode": "hamburger-only", "className": "header-navigation", "hamburgerTransform": true, "closeButton": false })} </nav> </div> </div> </header>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/sections/Header.astro", void 0);

const CookiePreferencesModal$1 = lazy(() => import('./CookiePreferencesModal_y7GVE1Wk.mjs'));
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal_y7GVE1Wk.mjs'));
...
const $$ConsentScript = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$6 || (_a$6 = __template$6(["<script>\n  // Check consent and notify - CookieConsentBanner handles the heavy lifting\n  (function() {\n    if (!document.cookie.includes('cookie-consent=')) return;\n    // Mark that consent exists for components to check\n    window.__CONSENT_EXISTS__ = true;\n  })();\n<\/script>"])));
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/preferences/consent/core/scripts/ConsentScript.astro", void 0);

const AccessibilityModal = lazy(() => import('./AccessibilityModal_CZ5b05lJ.mjs'));
function AccessibilityButton() {
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    ...
    showModal && /* @__PURE__ */ jsx(Suspense, { fallback: null, children: /* @__PURE__ */ jsx(AccessibilityModal, { isOpen: showModal, onClose: () => setShowModal(false) }) })
  ] });
}
...
var _a$5;
const $$Astro$7 = createAstro("https://griffinswebservices.com");
...
(function() {
  ...
  function fixGoogleTranslateIframes() {
    const iframes = document.querySelectorAll('iframe.goog-te-menu-frame, iframe.skiptranslate, iframe[id^="goog-gt"]');
  ...
  const iframeObserver = new MutationObserver(fixGoogleTranslateIframes);
  iframeObserver.observe(document.body, { childList: true, subtree: true });
  fixGoogleTranslateIframes();
})();
})();<\/script> `, '<div id="google_translate_element" style="display: none;" data-astro-cid-zobgwmfi></div> '])), defineScriptVars({ enableNative, enableGoogle }), maybeRenderHead());
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/preferences/language/core/scripts/BrowserTranslateScript.astro", void 0);

const $$Astro$6 = createAstro("https://griffinswebservices.com");
const $$PreferencesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ConsentScript", $$ConsentScript, {})}${renderComponent($$result, "BrowserTranslateScript", $$BrowserTranslateScript, { "enableNative": true, "enableGoogle": true })}${maybeRenderHead()}<div${addAttribute(wrapperClasses, "class")}> ${showHeading && renderTemplate`${renderComponent($$result, "DividerHeading", DividerHeading, { "title": "Preferences", "className": "mb-4" })}`} <div${addAttribute(itemsClasses, "class")}>  ${renderComponent($$result, "Button", Button, { "variant": "link", "href": "/privacy-policy#ccpa-rights", "size": "sm" }, { "default": ($$result2) => renderTemplate`
Do Not Sell My Personal Information
` })}  ${renderComponent($$result, "CookiePreferencesButton", CookiePreferencesButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/consent/ui/CookiePreferencesButton", "client:component-export": "default" })} ${renderComponent($$result, "CookieConsentBanner", CookieConsentBanner, { "client:firstInteraction": true, "client:component-hydration": "firstInteraction", "client:component-path": "@/integrations/preferences/consent/ui/CookieConsentBanner", "client:component-export": "default" })}  ${renderComponent($$result, "AccessibilityButton", AccessibilityButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/accessibility/ui/AccessibilityButton", "client:component-export": "default" })} </div> </div>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/PreferencesLayout.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "tag": "footer", "class": "mt-auto relative", "role": "contentinfo", "aria-label": "Site footer" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto w-full relative"> <div class="section-dim-border"></div> <div class="relative"> <nav aria-label="Footer navigation" class="inner-section grid gap-10 py-12 text-left sm:text-left grid-cols-1 md:grid-cols-2 xl:grid-cols-4 items-start"> <div class="flex flex-col items-start gap-6 text-sm max-w-lg"> ${renderComponent($$result2, "Logo", $$Logo, { "loading": "lazy", "trigger": "visible", "animateOutText": false, "loop": false, "class": "gap-2", "logoMediaClass": "block w-[64px] h-[64px] lg:w-[70px] lg:h-[70px] object-contain", "logoWidths": [70, 120, 150], "logoSizes": "(min-width: 1024px) 68px, 60px", "titleFirstClass": "text-4xl lg:text-5xl -ml-[0.1rem] leading-tight font-bold no-translate", "titleRestClass": "font-light emphasized-text uppercase text-sm md:text-base lg:text-lg p-0 m-0 tracking-[0.25em]", "altContext": "Footer" })} <p class="text-lg md:text-xl text-text"> ${siteData?.tagline} </p> ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query("contact-us"), "variant": "ContactListVariant" })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": related("menu-items", "menu", "footer-menu"), "variant": "ListVariant", "title": "Legal Links", "className": "text-bg flex flex-col items-start justify-center", "showHeadingDivider": true })} <!-- <ContentRenderer
            query={query("social-media")}
            variant="SocialMediaVariant"
            title="Follow Us"
            alignment="left"
          /> --> </div>  <div class="flex flex-col items-start gap-8 text-sm"> <!-- <ContentRenderer
            query={related("menu-items", "menu", "footer-menu-2")}
            variant="ListVariant"
            title="Links"
            className="text-bg flex flex-col items-start justify-center"
            showHeadingDivider
          /> --> ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": roots("industries"), "variant": "ListVariant", "showButtonSection": false, "showHeadingDivider": true })} </div>  ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": roots("capabilities"), "variant": "ListVariant", "showButtonSection": false, "showHeadingDivider": true })} <div class="flex flex-col space-y-5 lg:space-y-10">  ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": children("solutions", "new-builds"), "variant": "ListVariant", "title": "Web Solutions", "showButtonSection": false, "showHeadingDivider": true })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": children("solutions", "ongoing-solutions"), "variant": "ListVariant", "title": "Maintenance", "showButtonSection": false, "showHeadingDivider": true })} ${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": children("solutions", "one-time-jobs"), "variant": "ListVariant", "title": "Improvements", "showButtonSection": false, "showHeadingDivider": true })} </div> </nav> </div> <div class="relative"> <div class="section-dim-border"></div> <div class="inner-section flex flex-col gap-4 text-text text-sm py-6 sm:flex-row sm:items-center sm:justify-between" role="region" aria-label="Legal notice and preference controls"> <p class="text-center sm:text-right">
&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} ${siteData.legalName}. All rights reserved.
</p> ${renderComponent($$result2, "PreferencesLayout", $$PreferencesLayout, { "showHeading": false, "layout": "horizontal", "class": "w-full sm:w-auto" })} </div> </div> </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/sections/Footer.astro", void 0);
...
const $$GoogleTagManager = createComponent(($$result, $$props, $$slots) => {
  const GTM_ID = "GTM-TTGTZMFT";
  return renderTemplate`${renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate(_a$4 || (_a$4 = __template$4([`<script>
    ...
    </script><script type="text/plain" data-consent="performance" id="gtm-loader">`, "</script>"])), unescapeHTML(`
      ...
      `)) })}`}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/analytics/GoogleTagManager.astro", void 0);
...
})();<\/script>`])), defineScriptVars({ enableNative, enableGoogle }));
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/preferences/language/core/scripts/TranslationLoader.astro", void 0);

const $$Astro$4 = createAstro("https://griffinswebservices.com");
const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$Index$1;
  const propsStr = JSON.stringify(Astro2.props);
  const paramsStr = JSON.stringify(Astro2.params);
  return renderTemplate`${renderComponent($$result, "vercel-speed-insights", "vercel-speed-insights", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/@vercel/speed-insights/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const propsStr = JSON.stringify(Astro2.props);
  const paramsStr = JSON.stringify(Astro2.params);
  return renderTemplate`${renderComponent($$result, "vercel-analytics", "vercel-analytics", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/@vercel/analytics/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/node_modules/@vercel/analytics/dist/astro/index.astro", void 0);
...
const $$PartytownLoader = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$PartytownLoader;
  const { forward = ["dataLayer.push"], debug = false } = Astro2.props;
...
})();<\/script>`])), defineScriptVars({ forwardConfig, debug }));
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/partytown/PartytownLoader.astro", void 0);

const $$Astro$1 = createAstro("https://griffinswebservices.com");
const $$IntBodyScripts = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$IntBodyScripts;
  const {
    enableNativeTranslation = true,
    enableGoogleTranslation = true
  } = Astro2.props;
  return renderTemplate`<!-- Translation: Lightweight loader - full script loads only when needed -->${renderComponent($$result, "TranslationLoader", $$TranslationLoader, { "enableNative": enableNativeTranslation, "enableGoogle": enableGoogleTranslation })} <!-- Vercel Analytics & Speed Insights --> ${renderComponent($$result, "SpeedInsights", $$Index$1, {})} ${renderComponent($$result, "Analytics", $$Index, {})} <!-- Partytown: Conditional loader - only loads bootstrap if partytown scripts exist --> ${renderComponent($$result, "PartytownLoader", $$PartytownLoader, { "forward": ["dataLayer.push"] })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/IntBodyScripts.astro", void 0);

const $$IntFooterScripts = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Footer-level integration components --><!-- Add components here as needed -->${renderSlot($$result, $$slots["default"])}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/IntFooterScripts.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="scroll-smooth"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">${renderComponent($$result, "Theme", $$Theme, {})}<meta name="generator"${addAttribute(Astro2.generator, "content")}>${renderComponent($$result, "SEO", $$SEO, { "title": seoProps.title, ...seoProps })}${renderComponent($$result, "IntHeadScripts", $$IntHeadScripts, {})}${seoProps.noindex && renderTemplate`<meta name="robots" content="noindex,nofollow">`}${renderHead()}</head> <body class="antialiased"> <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-1/2 focus:-translate-x-1/2 focus:z-9999 focus:px-6 focus:py-3 focus:bg-primary focus:text-white focus:font-semibold focus:rounded-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-heading focus:ring-offset-2">
Skip to main content
</a>  ${renderComponent($$result, "IntBodyScripts", $$IntBodyScripts, {})}  <div id="app" class="min-h-screen flex flex-col"> ${renderComponent($$result, "Header", $$Header, {})}  <main id="main-content" class="flex-1" tabindex="-1" role="main" aria-label="Main content"> ${renderSlot($$result, $$slots["default"])} </main>  ${renderComponent($$result, "Footer", $$Footer, {})} </div>  ${renderComponent($$result, "IntFooterScripts", $$IntFooterScripts, {})} </body></html>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/BaseLayout.astro", void 0);

export { $$ContentRenderer as $, $$BaseLayout as A, useCookieStorage as B, enableConsentedScripts as C, $$Hero as D, optOutOfSale as E, useLanguageSwitcher as F, shouldCollectionHavePage as G, collections as H, isCollectionReference as I, $$SecondaryHero as J, FormWrapper as K, LanguageDropdown as L, Modal$1 as M, Input as N, submitToFormspree as O, getItemProperty as P, createSvgComponent as Q, __ASTRO_IMAGE_IMPORT_1x8Cut as R, __vite_glob_0_0$1 as S, Textarea as T, __vite_glob_0_1 as U, __vite_glob_0_2 as V, __vite_glob_0_3$1 as W, __vite_glob_0_4$1 as X, __vite_glob_0_5$1 as Y, __vite_glob_0_6$1 as Z, __vite_glob_0_0 as _, getPublishedCollection as a, __vite_glob_0_7$1 as a0, __vite_glob_0_8$1 as a1, __vite_glob_0_9$1 as a2, __vite_glob_0_10$1 as a3, __vite_glob_0_11$1 as a4, __vite_glob_0_12$1 as a5, __vite_glob_0_13$1 as a6, __vite_glob_0_14$1 as a7, __vite_glob_0_15$1 as a8, __vite_glob_0_16$1 as a9, __vite_glob_0_17$1 as aa, __vite_glob_0_18$1 as ab, getCollectionMeta as b, prepareCollectionEntries as c, getCollection as d, shouldItemHavePage as e, shouldItemUseRootPath as f, getItemKey as g, formatPhoneNumber as h, baseService as i, parseQuality as j, parseUrlPath as k, capitalizeWords as l, sortByOrder as m, $$TrustStatement as n, safeGetEntry as o, prepareEntry as p, query as q, related as r, shouldProcessCollection as s, children as t, sortByDate as u, $$CTASection as v, $$DoubleCard as w, roots as x, find as y, byTag as z };
