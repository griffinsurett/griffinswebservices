...
function SecureBrowserBar({
  ...
  return /* @__PURE__ */ jsx("div", { className: `bg-text/10 rounded-lg p-3 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex items-center gap-2 bg-bg2 rounded-md px-3 py-1.5", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: `flex items-center gap-1.5 primary-gradient rounded px-2 py-0.5 ${prefersReducedMotion ? "" : "transition-all duration-500 ease-out"} ${showBadge ? "opacity-100 translate-x-0 scale-100" : "opacity-0 -translate-x-4 scale-75"}`,
          children: [
