import { x as collections, y as isCollectionReference, f as find, $ as $$BaseLayout, a as $$ContentRenderer, q as query, F as FormWrapper, I as Input, T as Textarea, t as sortByOrder, r as related, z as capitalizeWords, A as getItemProperty, B as __vite_glob_0_0 } from './BaseLayout_BD8xUcJo.mjs';
...
import 'piccolore';
import { g as getImageSrc, a as getAuthorName } from './carousels_B6P9vI1t.mjs';
import { $ as $$SectionHeader } from './accordion_D9CVjMOr.mjs';
import './background_BMK_7jBH.mjs';
/* empty css                         */
import 'clsx';
import { s as siteData } from './wordpress_CB8A8Itm.mjs';
import { $ as $$DoubleCard, a as $$CTASection } from './DoubleCard_SJoqg0Ns.mjs';
...
const $$ServicesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { ...seoProps }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="flex-1">  ${renderComponent($$result2, "QuoteHero", $$QuoteHero, { "title": title, "heading": heading, "description": heroDescription, "primaryCTA": {
  ...
  }, "id": "services-quote-hero" })} <!-- <div
      class="block min-h-screen inner-section"
    ...
    >
      <ContentRenderer
        ...
        size="large"
      />
    </div> --> ${benefits.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "items": benefits, "variant": "CardVariant", "title": "Benefits", "heading": {
    before: "Why choose",
    text: title,
