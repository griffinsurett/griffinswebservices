...
/* empty css                          */
/* empty css                              */
import { b as shouldShowCollectionCTA, $ as $$SectionHeader, t as toArray, B as Button, d as $$ContentBridge, A as Accordion, H as Heading, _ as __vite_glob_0_26, P as POSTER_SRC } from './accordion_BPS4hUzo.mjs';
import { jsx, jsxs, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { F as FeatureCard } from './feature-cards_CmIprG0-.mjs';
...
import { u as useLazyLoad, L as LazyCookieConsent } from './lazy-utils_ldwAU6W-.mjs';
/* empty css                                 */
/* empty css                                                                              */
/* empty css                                     */
import { u as useVisibility, a as useScrollInteraction } from './visibility-hooks_CoeSV1Y5.mjs';
/* empty css                                                                      */
import { isRemoteAllowed } from '@astrojs/internal-helpers/remote';
import * as mime from 'mrmime';
/* empty css                                                                   */
import { I as IconListItem, a as Icon, A as AnimatedBorder } from './ui-primitives_B0JjTLio.mjs';
import { createPortal } from 'react-dom';
/* empty css                                                                             */
import { P as PortfolioScreenShowcase, b as PortfolioCarousel, T as TechStackSection, _ as __vite_glob_0_23 } from './carousels_DCo7UD_v.mjs';
/* empty css                                                               */
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C-6KiRp8.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BRIuCcoM.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DR0KHY39.mjs');
...
async function buildRelationshipGraph(options = {}) {
  ...
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_8XySPIuX.mjs');
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal_C_EIKOp2.mjs'));
...
function AccessibilityButton() {
  const { Component: Modal, isOpen, close } = useLazyLoad(
    () => import('./AccessibilityModal_5Avbhvp6.mjs'),
