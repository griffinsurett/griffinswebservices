...
const frontmatter = {
  ...
  "features": ["Single-page focused design", "Lead capture forms", "Mobile responsive", "Fast loading speed", "SEO optimized"]
};
...
function _createMdxContent(props) {
  ...
  return createVNode(_components.p, {
    children: "Landing pages are single-purpose web pages designed to convert visitors into leads or customers. Perfect for marketing campaigns, product launches, and promotional offers."
  });
}
