...
import 'piccolore';
import 'clsx';
import { s as siteData } from './solar_CecBMkpk.mjs';
/* empty css                         */
/* empty css                          */
/* empty css                              */
/* empty css                                 */
import { b as shouldShowCollectionCTA, $ as $$SectionHeader, t as toArray, B as Button, d as $$ContentBridge, A as Accordion, g as generateVideoPoster, V as Video, H as Heading, _ as __vite_glob_0_26, l as logoImg } from './accordion_D3cOwWQo.mjs';
import { jsx, jsxs, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { F as FeatureCard } from './feature-cards_BlaSKjeH.mjs';
...
import { u as useVisibility, a as useScrollInteraction } from './visibility-hooks_BoLPavqG.mjs';
/* empty css                                                                      */
import { isRemoteAllowed } from '@astrojs/internal-helpers/remote';
import * as mime from 'mrmime';
/* empty css                                                                   */
import { I as IconListItem, a as Icon, A as AnimatedBorder } from './ui-primitives_B6ctk6ji.mjs';
/* empty css                                                                             */
import { P as PortfolioScreenShowcase, b as PortfolioCarousel, T as TechStackSection, _ as __vite_glob_0_23 } from './carousels_DqHxjMZz.mjs';
/* empty css                                                                              */
/* empty css                                                               */
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DoZBJy1B.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_CSqphK2r.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_-RPq8yr1.mjs');
...
async function buildRelationshipGraph(options = {}) {
  ...
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_7iAPH5y6.mjs');
...
const CookiePreferencesModal$1 = lazy(() => import('./CookiePreferencesModal__ZuFbitJ.mjs'));
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal__ZuFbitJ.mjs'));
...
function AccessibilityButton() {
  const { Component: Modal, isOpen, close } = useLazyLoad(
    () => import('./AccessibilityModal_BVCLfpRO.mjs'),
