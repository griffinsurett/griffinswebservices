...
import { S as SquareCheckbox, C as CircleCheckbox } from './theme-shared_-yritbxk.mjs';
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative inline-flex", children: [
    /* @__PURE__ */ jsx(
      CircleCheckbox,
      {
        ...
        className: "faded-bg",
        children: /* @__PURE__ */ jsx("svg", { className: "w-4.5 h-4.5 sm:w-[22px] sm:h-[22px]", viewBox: "0 0 100 100", "aria-hidden": "true", children: /* @__PURE__ */ jsx(
          "path",
          {
