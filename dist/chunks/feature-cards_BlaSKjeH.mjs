...
import { A as AnimatedBorder, I as IconListItem } from './ui-primitives_B6ctk6ji.mjs';
...
function FeatureCard({
  ...
  const innerCardClass = resolvedLayout.includes("horizontal") ? "lg:h-55 w-full px-4 md:px-8 py-6 relative flex flex-col justify-center items-center card-bg" : "h-90 mx-auto px-6 md:px-10 flex flex-col justify-center items-center relative card-bg";
