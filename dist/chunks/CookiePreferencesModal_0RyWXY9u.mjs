...
import { v as useCookieStorage, M as Modal, B as Button, A as Accordion, w as enableConsentedScripts } from './BaseLayout_BNcvlav2.mjs';
    ...
    Modal,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-text text-sm lg:text-base leading-relaxed mb-3", children: [
