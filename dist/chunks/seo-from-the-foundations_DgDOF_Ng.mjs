...
import { a as Icon } from './ui-primitives_D9GtZ6Qp.mjs';
import { u as useMotionPreference } from './BaseLayout_BD8xUcJo.mjs';
import 'clsx';
...
function GoogleListing({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative bg-bg2 rounded-lg p-4 text-left border border-text/10 overflow-hidden ${className}`, children: [
    ...
    /* @__PURE__ */ jsxs("p", { className: "text-sm text-text/60 leading-relaxed", children: [
      ...
      description,
      /* @__PURE__ */ jsx("span", { className: "text-primary ml-1 cursor-pointer hover:underline", children: "Read more" })
    ] }),
    /* @__PURE__ */ jsx(
      "div",
      {
        className: `absolute pointer-events-none ${prefersReducedMotion ? "" : "animate-[cursorMove_3s_ease-in-out_infinite]"}`,
        style: {
          top: "50px",
          left: "-20px",
          // Final state: cursor at position over the title
          transform: prefersReducedMotion ? "translate(80px, 10px)" : void 0
        },
...
const file = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/content/benefits/seo-from-the-foundations.mdx";
...
Content.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/content/benefits/seo-from-the-foundations.mdx";
