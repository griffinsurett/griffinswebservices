import { a as createComponent, c as createAstro, m as maybeRenderHead, d as renderComponent, b as addAttribute, e as renderTemplate, f as createVNode, F as Fragment, _ as __astro_tag_component__ } from './astro/server_CJgvfkPK.mjs';
import { s as siteData } from './siteData_1iA5IhsI.mjs';
import 'piccolore';
import { jsxs, jsx } from 'react/jsx-runtime';
import { useState } from 'react';
import { E as optOutOfSale, y as find, h as formatPhoneNumber } from './BaseLayout_BXen9sOm.mjs';
import { $ as $$LegalContactSection } from './LegalContactSection_CTdRAzie.mjs';
import 'clsx';
...
function OptOutButton() {
  ...
  if (showConfirmation) {
    return /* @__PURE__ */ jsxs("div", { className: "bg-success/10 border-2 border-success rounded-lg p-6", children: [
      /* @__PURE__ */ jsx("p", { className: "font-bold text-success text-lg", children: "✅ Success!" }),
      /* @__PURE__ */ jsx("p", { className: "text-success/80 text-sm mt-2", children: "You've opted out. Non-essential cookies disabled. Reloading..." })
    ] });
  }
  return /* @__PURE__ */ jsx(
    "button",
...
Click below to instantly disable all non-essential cookies and stop data
      sharing:
</p> ${renderComponent($$result, "OptOutButton", OptOutButton, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/preferences/consent/ui/OptOutButton", "client:component-export": "default" })} </div> <div class="bg-text/5 border-2 border-surface rounded-lg p-6 my-6"> <h3 class="mt-0">Other Ways to Opt Out</h3> <div class="mb-4"> <p class="font-semibold mb-2">Manage Individual Cookie Categories</p> <button id="open-cookie-preferences" class="bg-bg border-2 border-primary text-primary px-6 py-3 rounded-lg font-bold hover:bg-primary/10 transition-colors" type="button">
🍪 Cookie Settings
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/integrations/preferences/consent/ui/PrivacyPolicy/CCPARights.astro", void 0);
...
const file = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/legal/privacy-policy.mdx";
...
Content.moduleId = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/content/legal/privacy-policy.mdx";
