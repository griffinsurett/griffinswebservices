...
import { C as ClientImage, a as animationProps, s as staggeredAnimationProps, H as Heading, b as shouldShowCollectionCTA, $ as $$SectionHeader, t as toArray, B as Button } from './accordion_D9CVjMOr.mjs';
import { a as useEngagementAutoScroll, b as useSideDragNavigation, u as useEngagementAutoplay } from './engagement-hooks_CkX9sE7P.mjs';
import { u as useVisibility } from './visibility-hooks_kFeFuXCC.mjs';
import { a as Icon, A as AnimatedBorder, I as IconListItem } from './ui-primitives_D9GtZ6Qp.mjs';
...
function ScrollableViewport({
  ...
  const defaultCycleMs = targetDurationSec * 1e3;
  ...
  useEffect(() => {
    ...
    const totalDuration = AUTO_SCROLL_START_DELAY_MS + effectiveDuration + BETWEEN_SLIDE_PAUSE_MS;
    const timer = window.setTimeout(() => {
...
export { PortfolioScreenShowcase as P, TechStackSection as T, __vite_glob_0_25 as _, getAuthorName as a, PortfolioCarousel as b, getImageSrc as g };
