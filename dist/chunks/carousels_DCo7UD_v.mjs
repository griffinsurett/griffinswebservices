...
import { a as useEngagementAutoScroll, u as useEngagementAutoplay, b as useSideDragNavigation } from './engagement-hooks_CHyvIMzv.mjs';
import { a as animationProps, s as staggeredAnimationProps, H as Heading, b as shouldShowCollectionCTA, $ as $$SectionHeader, t as toArray, B as Button } from './accordion_BPS4hUzo.mjs';
import { u as useVisibility } from './visibility-hooks_CoeSV1Y5.mjs';
import { a as Icon, A as AnimatedBorder, I as IconListItem } from './ui-primitives_B0JjTLio.mjs';
...
function ComputerScreen({
  ...
  return /* @__PURE__ */ jsx("div", { className: "relative h-full w-full", onClick: enableScroll, children: /* @__PURE__ */ jsxs("div", { className: "relative h-full bg-bg3", children: [
...
function PortfolioScreenShowcase({
  ...
  return /* @__PURE__ */ jsx("div", { className: `relative h-full ${className}`.trim(), children: /* @__PURE__ */ jsx("div", { className: "relative h-full w-full overflow-hidden card-bg rounded-lg", children: slides.map((item, slideIndex) => {
