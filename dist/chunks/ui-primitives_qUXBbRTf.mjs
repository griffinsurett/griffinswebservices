...
import { FaWordpress, FaWandMagicSparkles, FaUtensils, FaUniversalAccess, FaTruckFast, FaTrophy, FaStar, FaShopify, FaShieldHeart, FaShieldHalved, FaServer, FaScrewdriverWrench, FaRocket, FaRobot, FaReact, FaPython, FaPlug, FaPhp, FaPenToSquare, FaPenNib, FaNodeJs, FaMobileScreenButton, FaMagnifyingGlassChart, FaMagnifyingGlass, FaLocationDot, FaListCheck, FaLifeRing, FaLayerGroup, FaLaptop, FaKey, FaJs, FaImages, FaHtml5, FaHelmetSafety, FaHeartPulse, FaHeadset, FaHandshake, FaGithub, FaFlask, FaFileLines, FaFigma, FaFeatherPointed, FaFeather, FaEnvelopeOpenText, FaEnvelopeCircleCheck, FaDumbbell, FaCss3Alt, FaCrown, FaCoins, FaCode, FaCloudflare, FaClone, FaClockRotateLeft, FaClock, FaChartSimple, FaChartPie, FaChartLine, FaCartShopping, FaCartArrowDown, FaCamera, FaCalendarCheck, FaBullseye, FaBriefcase, FaBoxesStacked, FaBoxOpen, FaBolt, FaBagShopping, FaAws, FaAward, FaArrowsUpDownLeftRight, FaArrowTrendUp } from 'react-icons/fa6';
