...
function SupportChat({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxs(DecorativeWrapper, { className: `flex gap-4 select-none pointer-events-none ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-text/10 rounded-lg overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-bg2 px-3 py-2 flex items-center gap-2 border-b border-text/10", children: [
        /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: FAVICON_DATA_URI, alt: "GWS", className: "w-full h-full object-cover" }) }),
