...
/* empty css                              */
/* empty css                                 */
import { $ as $$Section, b as shouldShowCollectionCTA, c as $$SectionHeader, t as toArray, B as Button, d as $$ContentBridge, A as Accordion, g as generateVideoPoster, V as Video, H as Heading, _ as __vite_glob_0_31, l as logoImg } from './accordion_B-QbiZo0.mjs';
import { jsx, jsxs, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { F as FeatureCard } from './feature-cards_DIbz18h9.mjs';
import { A as AnimatedBorder, I as IconListItem, a as Icon } from './ui-primitives_Bsx-jmXS.mjs';
import { createElement, createContext, useState, useRef, Children, isValidElement, useEffect, useMemo, useId, useCallback, memo, lazy, Suspense, useTransition } from 'react';
import { u as useLanguageSwitcher, L as LanguageDropdown, s as subscribeToCookiePreferencesRequests } from './theme-language_HN0clqaR.mjs';
...
import { u as useVisibility, a as useScrollInteraction } from './visibility-hooks_DQjkHnQK.mjs';
/* empty css                                                                      */
import { isRemoteAllowed } from '@astrojs/internal-helpers/remote';
import * as mime from 'mrmime';
import { a as getAuthorName, F as FilterTabs, b as FilteredPortfolioCarousel, P as PortfolioScreenShowcase, c as PortfolioCarousel, T as TechStackSection, d as TestimonialCard, _ as __vite_glob_0_27 } from './carousels_DABWNipX.mjs';
/* empty css                                                                     */
/* empty css                                                                              */
/* empty css                                                               */
import { D as DarkLightToggle } from './theme-toggle_22Cnwjtl.mjs';
import { A as AccentPicker } from './theme-accent_BMeLCr3J.mjs';
import { C as CircleCheckbox } from './theme-shared_YRaDe80i.mjs';
...
const $$SEO = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$SEO;
  const defaultOGImage = { src: "/2dfavicons/android-chrome-512x512.png" };
  const {
    title,
    description,
    image,
...
const $$file$u = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/AccordionVariant.astro";
...
const $$file$t = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/BenefitsInlineVariant.astro";
...
const $$MasonryGrid = createComponent(($$result, $$props, $$slots) => {
  ...
  const leftColumn = leftColumnTitles.map((title) => items.find((item) => item.title === title)).filter((item) => item !== void 0);
  const rightColumn = rightColumnTitles.map((title) => items.find((item) => item.title === title)).filter((item) => item !== void 0);
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/LoopTemplates/MasonryGrid.astro", void 0);
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/BenefitsVariant.astro", void 0);

const $$file$s = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/BenefitsVariant.astro";
...
function BlogCard({
  ...
  const hoverLift = isInteractive ? "hover:-translate-y-3" : "";
  ...
  return /* @__PURE__ */ jsx("div", { className, children: /* @__PURE__ */ jsxs(
    AnimatedBorder,
    {
      ...
      linkProps: isInteractive ? { href: url } : void 0,
      innerClassName: "card-bg overflow-hidden relative",
      children: [
        /* @__PURE__ */ jsx("div", { className: "inner-card-style inner-card-transition inner-card-color" }),
        featuredImage && /* @__PURE__ */ jsx("div", { className: "relative w-full aspect-video overflow-hidden z-10", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: featuredImage,
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/TrustStatement.astro", void 0);
...
const $$BlogIndexLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { ...seoProps }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "SecondaryHero", $$SecondaryHero, { "title": pageTitle, "description": pageDescription, "image": heroImage })} ${maybeRenderHead()}<div class="container mx-auto px-4 pb-16"> ${hasContent && Content ? (
    /* Custom MDX content from _meta.mdx body */
    renderTemplate`${renderComponent($$result2, "Content", Content, {})}`
  ) : (
    /* Default: Grid of blog posts */
    renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "query": query(collectionName), "variant": "BlogVariant", "columns": 2 })}`
  )} </div> ` })}`;
...
const $$file$r = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/layouts/collections/BlogIndexLayout.astro";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CTHK8fWR.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BNNJ-GJ2.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CvG2JgXo.mjs');
...
async function prepareEntry(entry, collection, meta) {
  ...
  const { applyLinkBehavior, mergeLinkBehavior } = await import('./linkBehavior_9QyPRdZl.mjs');
...
async function buildRelationshipGraph(options = {}) {
  ...
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_iu57X-tE.mjs');
...
const $$BlogVariant = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `py-16 ${className}` }, { "default": async ($$result2) => renderTemplate`${(title || description) && renderTemplate`${maybeRenderHead()}<div class="text-center mb-12"> ${title && renderTemplate`<h2 class="text-4xl font-bold mb-4">${title}</h2>`} ${description && renderTemplate`<p class="text-lg text-text max-w-2xl mx-auto">${description}</p>`} </div>`}${resolvedItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} gap-8 list-none`, "class")}> ${resolvedItems.map((item) => renderTemplate`<li> ${renderComponent($$result2, "BlogCard", BlogCard, { "client:visible": true, "title": item.title, "description": item.description, "url": item.url, "featuredImage": item.featuredImage, "featuredImageAlt": item.featuredImageAlt, "publishDate": item.publishDate, "author": item.author, "client:component-hydration": "visible", "client:component-path": "@/components/LoopComponents/BlogCard", "client:component-export": "default" })} </li>`)} </ul>`}${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="mt-12 text-center"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "primary", "size": "lg" }, { "default": async ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`}` })}`;
...
const $$file$q = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/BlogVariant.astro";
...
const $$file$p = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/CardVariant.astro";
...
const $$file$o = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ChecklistVariant.astro";
...
const $$file$n = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ComparisonVariant.astro";
...
const $$ContactListVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const safeItems = toArray(items);
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `${className}` }, { "default": ($$result2) => renderTemplate`${showHeadingSection && (title || description) && renderTemplate`${renderComponent($$result2, "DividerHeading", DividerHeading, { "title": title, "showDivider": showHeadingDivider, "className": "mb-4", "headingClassName": "h4 text-heading" })}`}${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<ul class="flex flex-col items-start justify-center gap-2 list-none"> ${safeItems.map((item) => {
    const href = item.url;
    const displayTitle = item.title;
    const displayValue = item.displayValue ?? item.description;
    const iconName = item.icon;
    return renderTemplate`<li class="py-0"${addAttribute(item.slug, "data-contact-id")}> ${href ? renderTemplate`<a${addAttribute(href, "href")} class="flex items-center gap-1 group hover:text-primary transition-colors"> <span class="w-12 h-12 rounded-full flex items-center justify-center shrink-0 transition-colors"> ${renderComponent($$result2, "Icon", Icon, { "icon": iconName, "size": "md", "className": "w-7 h-7 text-primary" })} </span> <span class="flex flex-col"> <span class="text-heading font-semibold"> ${displayTitle} </span> <span class="text-sm text-text/70"> ${displayValue} </span> </span> </a>` : renderTemplate`<div class="flex items-center gap-3"> <span class="w-12 h-12 rounded-full flex items-center justify-center text-primary shrink-0"> ${renderComponent($$result2, "Icon", Icon, { "icon": iconName, "size": "md", "className": "w-5 h-5" })} </span> <div class="flex flex-col"> <span class="text-heading font-semibold"> ${displayTitle} </span> <span class="text-sm text-text/70"> ${displayValue} </span> </div> </div>`} </li>`;
  })} </ul>`}` })}`;
...
const $$file$m = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ContactListVariant.astro";
...
const $$file$l = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ContactVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/FilteredCardVariant.astro", void 0);

const $$file$k = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/FilteredCardVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/FilteredPortfolioVariant.astro", void 0);

const $$file$j = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/FilteredPortfolioVariant.astro";
...
const $$file$i = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/GridVariant.astro";
...
const $$file$h = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/IconListVariant.astro";
...
const $$file$g = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/LinkTreeVariant.astro";
...
const $$file$f = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ListCardVariant.astro";
...
const $$file$e = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ListVariant.astro";
...
const $$file$d = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/MasonryVariant.astro";
          ...
          "nav",
          {
            ...
            children: /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: "relative w-full h-full overflow-hidden flex justify-left lg:justify-center", children: /* @__PURE__ */ jsx(
                  "div",
                  {
...
const $$file$c = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/MenuVariant.astro";
...
const $$file$b = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/PainPointsVariant.astro";
...
const $$file$a = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/PortfolioScreenVariant.astro";
...
const $$file$9 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/PortfolioVariant.astro";
...
const $$file$8 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/ProofPointsVariant.astro";
...
const $$file$7 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/QuickFactsVariant.astro";
...
const $$file$6 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/SocialMediaVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/SplitHighlightsVariant.astro", void 0);

const $$file$5 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/SplitHighlightsVariant.astro";
...
const $$file$4 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/StatsVariant.astro";
...
const $$file$3 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TechnologiesVariant.astro";
...
const $$file$2 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TestimonialCirclesVariant.astro";
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TestimonialGridVariant.astro", void 0);

const $$file$1 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TestimonialGridVariant.astro";
...
const $$TwoColumnImageVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  })} </div>`}  ${showCTA && renderTemplate`<div class="mt-8"> ${renderComponent($$result2, "Button", Button, { "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> </div> </div> ` })}`;
...
async function getVariantComponents() {
  const variants = /* #__PURE__ */ Object.assign({"../AccordionVariant.astro": __vite_glob_0_0$2,"../BenefitsInlineVariant.astro": __vite_glob_0_1$1,"../BenefitsVariant.astro": __vite_glob_0_2$1,"../BlogVariant.astro": __vite_glob_0_3,"../CardVariant.astro": __vite_glob_0_4,"../ChecklistVariant.astro": __vite_glob_0_5,"../ComparisonVariant.astro": __vite_glob_0_6,"../ContactListVariant.astro": __vite_glob_0_7,"../ContactVariant.astro": __vite_glob_0_8,"../FilteredCardVariant.astro": __vite_glob_0_9,"../FilteredPortfolioVariant.astro": __vite_glob_0_10,"../GridVariant.astro": __vite_glob_0_11,"../IconListVariant.astro": __vite_glob_0_12,"../LinkTreeVariant.astro": __vite_glob_0_13,"../ListCardVariant.astro": __vite_glob_0_14,"../ListVariant.astro": __vite_glob_0_15,"../MasonryVariant.astro": __vite_glob_0_16,"../MenuVariant.astro": __vite_glob_0_17,"../PainPointsVariant.astro": __vite_glob_0_18,"../PortfolioScreenVariant.astro": __vite_glob_0_19,"../PortfolioVariant.astro": __vite_glob_0_20,"../ProofPointsVariant.astro": __vite_glob_0_21,"../QuickFactsVariant.astro": __vite_glob_0_22,"../SocialMediaVariant.astro": __vite_glob_0_23,"../SplitHighlightsVariant.astro": __vite_glob_0_24,"../StatsVariant.astro": __vite_glob_0_25,"../TechnologiesVariant.astro": __vite_glob_0_26,"../TestimonialCarouselVariant.astro": __vite_glob_0_27,"../TestimonialCirclesVariant.astro": __vite_glob_0_28,"../TestimonialGridVariant.astro": __vite_glob_0_29,"../TwoColumnImageVariant.astro": __vite_glob_0_30,"../VideoAccordionVariant.astro": __vite_glob_0_31});
...
const $$Logo = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a href="/" translate="no"${addAttribute(`notranslate flex justify-center items-center gap-1 lg:gap-1.5 ${className}`, "class")}> ${shouldUseLottie ? renderTemplate`${renderComponent($$result, "LottieLogo", LottieLogo, { "alt": alt, "loading": loading, "trigger": trigger, "className": "logo-class", "mediaClasses": logoClasses, "loop": loop, "client:scroll": true, "client:component-hydration": "scroll", "client:component-path": "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/Logo/LottieLogo", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Image", $$Image, { "src": logoImg, "alt": "", "loading": loading, "decoding": "async", "class": logoClasses, "widths": LOGO_WIDTHS, "sizes": LOGO_SIZES, "fetchpriority": loading === "eager" ? "high" : "low", "aria-hidden": "true" })} ` })}` : renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": logoImg, "alt": alt, "loading": loading, "decoding": "async", "class": logoClasses, "widths": LOGO_WIDTHS, "sizes": LOGO_SIZES, "fetchpriority": loading === "eager" ? "high" : void 0 })}`} <div> ${renderComponent($$result, "TextLogoStatic", $$TextLogoStatic, { "title": siteData.title, "className": "flex flex-col p-0 m-0", "fadeDuration": textFadeMs, "animateOutText": animateOutText, "firstClass": titleFirstClass, "restClass": titleRestClass })} </div> </a>`;
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative contents", children: [
    /* @__PURE__ */ jsx(
      CircleCheckbox,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-xl leading-none", "aria-hidden": "true", children: currentLanguage.flag || "🌐" }) })
      }
    ),
    open && /* @__PURE__ */ jsx(
      LanguageDropdown,
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="fixed w-full top-0 z-[100000]" role="banner"> <div class="relative flex items-center justify-between head-foot-section py-2 gap-4"> <!-- Logo --> ${renderComponent($$result, "Logo", $$Logo, { "loading": "eager", "trigger": "scroll", "animateOutText": true, "altContext": "Home" })} ${renderComponent($$result, "ThemeControls", ThemeControls, { "className": "hidden lg:flex", "client:hover": true, "client:component-hydration": "hover", "client:component-path": "@/components/ThemeControls/ThemeControls.jsx", "client:component-export": "default" })} <div class="flex items-center gap-4"> ${renderComponent($$result, "ThemeControls", ThemeControls, { "className": "lg:hidden", "client:hover": true, "client:component-hydration": "hover", "client:component-path": "@/components/ThemeControls/ThemeControls.jsx", "client:component-export": "default" })} <div class="flex items-center justify-center sm:gap-4"> <!-- Navigation Menu using query --> ${renderComponent($$result, "ContentRenderer", $$ContentRenderer, { "query": related("menu-items", "menu", "main-menu"), "variant": "MenuVariant", "mode": "hamburger-only", "className": "header-navigation", "hamburgerTransform": true, "closeButton": false })} </div> </div> </div> </header>`;
...
const CookiePreferencesModal$1 = lazy(() => import('./CookiePreferencesModal_C1ilHgGw.mjs'));
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal_C1ilHgGw.mjs'));
...
const AccessibilityModal = lazy(() => import('./AccessibilityModal_Ae1vJyr0.mjs'));
...
(function() {
  ...
  // Run periodically to catch dynamically injected iframes
...
` })}  ${renderComponent($$result, "CookiePreferencesButton", CookiePreferencesButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/consent/components/CookiePreferencesButton", "client:component-export": "default" })} ${renderComponent($$result, "CookieConsentBanner", CookieConsentBanner, { "client:firstInteraction": true, "client:component-hydration": "firstInteraction", "client:component-path": "@/integrations/preferences/consent/components/CookieConsentBanner", "client:component-export": "default" })}  ${renderComponent($$result, "AccessibilityButton", AccessibilityButton$1, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/integrations/preferences/accessibility/components/AccessibilityButton", "client:component-export": "default" })} </div> </div>`;
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="scroll-smooth"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">${renderComponent($$result, "Theme", $$Theme, {})}${renderComponent($$result, "AccessibilityScript", $$AccessibilityScript, {})}<meta name="generator"${addAttribute(Astro2.generator, "content")}>${renderComponent($$result, "SEO", $$SEO, { "title": seoProps.title, ...seoProps })}${renderComponent($$result, "HeadTags", $$HeadTags, {})}${seoProps.noindex && renderTemplate`<meta name="robots" content="noindex,nofollow">`}${renderHead()}</head> <body class="antialiased"> <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-1/2 focus:-translate-x-1/2 focus:z-9999 focus:px-6 focus:py-3 focus:bg-primary focus:text-white focus:font-semibold focus:rounded-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-heading focus:ring-offset-2">
Skip to main content
</a>  ${renderComponent($$result, "BodyTags", $$BodyTags, {})}  <div id="app" class="min-h-screen flex flex-col"> ${renderComponent($$result, "Header", $$Header, {})}  <main id="main-content" class="flex-1" tabindex="-1"> ${renderSlot($$result, $$slots["default"])} </main>  ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
...
export { $$BaseLayout as $, __ASTRO_IMAGE_IMPORT_1x8Cut as A, __ASTRO_IMAGE_IMPORT_s0yHl as B, baseService as C, parseQuality as D, useMotionPreference as E, FormWrapper as F, $$TrustStatement as G, parseUrlPath as H, Input as I, safeGetEntry as J, children as K, optOutOfSale as L, Modal$1 as M, __vite_glob_0_0$1 as N, __vite_glob_0_1 as O, __vite_glob_0_2 as P, __vite_glob_0_3$1 as Q, __vite_glob_0_4$1 as R, __vite_glob_0_5$1 as S, Textarea as T, __vite_glob_0_6$1 as U, __vite_glob_0_7$1 as V, __vite_glob_0_8$1 as W, __vite_glob_0_9$1 as X, __vite_glob_0_10$1 as Y, __vite_glob_0_11$1 as Z, __vite_glob_0_0 as _, $$ContentRenderer as a, __vite_glob_0_12$1 as a0, __vite_glob_0_13$1 as a1, __vite_glob_0_14$1 as a2, __vite_glob_0_15$1 as a3, __vite_glob_0_16$1 as a4, shouldProcessCollection as b, getCollection as c, getItemKey as d, shouldItemHavePage as e, shouldItemUseRootPath as f, getCollectionMeta as g, collections as h, isCollectionReference as i, find as j, capitalizeWords as k, $$SecondaryHero as l, getItemProperty as m, roots as n, sortByOrder as o, byTag as p, query as q, related as r, shouldCollectionHavePage as s, $$CTASection as t, getImage as u, $$Counter as v, formatPhoneNumber as w, useCookieStorage as x, enableConsentedScripts as y, createSvgComponent as z };
