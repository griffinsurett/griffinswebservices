import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, r as renderSlot, e as renderTemplate, d as renderComponent } from './astro/server_CJgvfkPK.mjs';
import 'piccolore';
import { k as parseUrlPath, o as safeGetEntry, l as capitalizeWords, r as related, $ as $$ContentRenderer, m as sortByOrder, v as $$CTASection } from './BaseLayout_BXen9sOm.mjs';
import { $ as $$Section, c as $$SectionHeader, B as Button } from './accordion_D0NzPMSA.mjs';
import { I as IconListItem } from './ui-primitives_Bpudp7Rf.mjs';
import 'clsx';
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentContainer.astro", void 0);
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/sections/ContentSection.astro", void 0);
...
const $$SolutionsSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ContentSection", $$ContentSection, { "heading": contentHeading, "primaryCTA": primaryCTA, "secondaryCTA": secondaryCTA, "sidebar": fullSidebar }, { "quick-facts": async ($$result2) => renderTemplate`${quickFacts.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "slot": "quick-facts", "items": quickFacts, "variant": "QuickFactsVariant", "columns": 1 })}`}`, "text": async ($$result2) => renderTemplate`${maybeRenderHead()}<div class="space-y-6 text-lg text-muted"> ${textContent.map((paragraph) => renderTemplate`<p>${paragraph}</p>`)} </div>` })} ${slug && renderTemplate`${renderComponent($$result, "ContentRenderer", $$ContentRenderer, { "query": related("benefits", "solutions", slug), "variant": "BenefitsVariant", "columns": 2, "gap": "lg", "title": benefitsTitle, "heading": benefitsHeading || `What Makes Our ${title} Different` })}`} ${slug && renderTemplate`${renderComponent($$result, "ContentRenderer", $$ContentRenderer, { "query": related("features", "solutions", slug).orderBy(sortByOrder()), "variant": "IconListVariant", "columns": 2, "gap": "lg", "heading": `Optional add-ons for your ${title?.toLowerCase() || "project"}`, "description": `Enhance your ${title?.toLowerCase() || "solution"} with these additional features and capabilities.` })}`}  ${renderComponent($$result, "BottomContentSection", $$BottomContentSection, { "collection": "solutions", "slug": slug, "pageTitle": title, "portfolio": false, "technologies": false, "faq": {
    title: faqTitle,
...
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/layouts/sections/SolutionsSection.astro", void 0);
