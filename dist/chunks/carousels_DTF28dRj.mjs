...
import { B as Button, a as animationProps, C as ClientImage, s as staggeredAnimationProps, H as Heading, $ as $$Section, b as shouldShowCollectionCTA, c as $$SectionHeader, t as toArray } from './accordion_D0NzPMSA.mjs';
import { a as useEngagementAutoScroll, b as useSideDragNavigation, u as useEngagementAutoplay } from './engagement-hooks_Cxd_mCVz.mjs';
import './scroll-observer_BfsajYDo.mjs';
import { u as useVisibility } from './visibility-hooks_CBlb6Wug.mjs';
import { a as Icon, A as AnimatedBorder, I as IconListItem } from './ui-primitives_Bpudp7Rf.mjs';
import { a as createComponent, c as createAstro, d as renderComponent, e as renderTemplate, m as maybeRenderHead } from './astro/server_CJgvfkPK.mjs';
import 'piccolore';
...
function FilterTab({
  ...
  const iconProp = variant === "filterIcon" ? { icon: option.icon } : { leftIcon: option.icon };
  return /* @__PURE__ */ jsx(
    Button,
    {
      variant,
...
function FilterTabs({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      className: `flex gap-2 items-start justify-center overflow-x-auto scrollbar-hide ${className}`.trim(),
      role: "radiogroup",
      "aria-label": `Filter by ${groupingField || "category"}`,
      children: reorderedOptions.map((option) => /* @__PURE__ */ jsx(
        FilterTab,
        {
          option,
...
const MANUAL_SCROLL_TIMEOUT_MS = 3e3;
...
const AUTO_SCROLL_MIN_DURATION_MS = 3e3;
...
function ScrollableViewport({
  ...
  const measureScrollDuration = useCallback(
    (host) => {
      ...
      const durationMs = Math.round(maxScrollable / speedPxPerSec * 1e3);
  ...
  const autoScroll = useEngagementAutoScroll({
    ...
    speed: speedPxPerSec,
    // Fixed speed - same for all content
    loop: false,
  ...
  useEffect(() => {
    ...
    const totalDuration = AUTO_SCROLL_START_DELAY_MS + scrollDurationRef.current + BETWEEN_SLIDE_PAUSE_MS;
    const timer = window.setTimeout(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          ...
          {
            ref: viewportRef,
            className: `absolute inset-0 overflow-y-scroll bg-black/40 ${manualScrollEnabled ? "overscroll-contain touch-pan-y" : "pointer-events-none touch-none"}`,
            style: {
...
const ChevronLeftIcon$1 = ({ className = "" }) => /* @__PURE__ */ jsx(
  "svg",
  {
    className,
    fill: "currentColor",
...
const ChevronRightIcon$1 = ({ className = "" }) => /* @__PURE__ */ jsx(
  "svg",
  {
    className,
    fill: "currentColor",
...
const arrowClasses = "hidden md:flex w-10 h-10 rounded-full faded-bg text-text backdrop-blur-sm transition hover:bg-heading/20 hover:border-heading/50 shrink-0 items-center justify-center";
...
function FilterNavigation({
  ...
  return /* @__PURE__ */ jsx("div", { className: `flex justify-center ${className}`.trim(), children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 inner-section w-full", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsx(ChevronLeftIcon$1, { className: iconClasses })
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "overflow-hidden horizontal-edge-fade flex-1 min-w-0", children }),
    /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsx(ChevronRightIcon$1, { className: iconClasses })
      }
    )
  ] }) });
}

const INTERACTIVE_ELEMENTS = /* @__PURE__ */ new Set(["INPUT", "TEXTAREA", "SELECT"]);
...
function KeyboardNavigableContainer({
  children,
  onPrevious,
  onNext,
...
const SLIDE_TRANSITION_DURATION_MS$1 = 750;
function useImageCycling({
  totalImages,
  isActive,
  onCycleComplete,
  resetOnActivate = true
  ...
  const startTransition = useCallback(
    (targetIndex) => {
      ...
      transitionTimerRef.current = window.setTimeout(() => {
        setTransitionStage("idle");
        setPrevImageIndex(null);
      }, SLIDE_TRANSITION_DURATION_MS$1);
    },
    [imageIndex]
  );
...
function getPortfolioImageSrc(item) {
  return getImageSrc(item.featuredImage) || getImageSrc(item.bannerImage) || getImageSrc(item.image) || "";
}
...
function GroupSlide({
  ...
  const renderMedia = (item, mediaEntry) => {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "relative h-full w-full", children: group.items.length === 1 ? (
        ...
        /* @__PURE__ */ jsx(
          ScrollableViewport,
          {
            ...
            children: renderMedia(currentItem, currentMediaEntry)
          }
        )
      ) : (
        // Multiple items - cycle through with slide transitions
        /* @__PURE__ */ jsx("div", { className: "relative h-full w-full overflow-hidden", children: group.items.map((item, idx) => {
          ...
          return /* @__PURE__ */ jsx(
            "div",
            {
              className: `${baseTransitionClass} ${translateClass} ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"}`,
              children: /* @__PURE__ */ jsx(
                ScrollableViewport,
                {
                  isActive: isActive && isActiveImage,
                  isTransitioning,
                  onScrollComplete: isActiveImage ? handleScrollComplete : void 0,
                  speedPxPerSec: 98,
                  resetOnActivate: true,
                  showDevOverlay: true,
                  className: "w-full h-full bg-gray-900 m-0 p-0",
                  children: renderMedia(item, group.mediaEntries[idx])
                }
              )
            },
            item.slug ?? item.id ?? idx
          );
        }) })
      ) })
    }
...
function FilteredPortfolioCarousel({
  groups: groupsProp = [],
  filter,
  filterSize = "sm",
  filterClassName = "",
  ...
  const filterGroups = useMemo(() => groupsProp, [groupsProp]);
  ...
  const activeSlideHandlersRef = useRef(null);
  const setActiveSlideHandlers = useCallback((handlers) => {
    ...
    KeyboardNavigableContainer,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          "data-filtered-carousel-container": true,
          suppressHydrationWarning: true,
          children: [
            showFilters && shouldShowFilters && /* @__PURE__ */ jsx(
              FilterNavigation,
              {
                onPrevious: goToPrevious,
                onNext: goToNext,
            ...
            ready && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
              "div",
              {
                  ...
                  filterGroups.map((group, idx) => {
                    ...
                    return /* @__PURE__ */ jsx(
                      GroupSlide,
                      {
                        ...
                        onRegisterHandlers: isActiveSlide ? setActiveSlideHandlers : void 0
                      },
                      group.key
                    );
                  }),
                  drag && filterGroups.length > 1 && /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ref: leftZoneRef,
...
function ComputerScreen({
  ...
  const renderMedia = () => {
    if (!isHydrated) {
      return /* @__PURE__ */ jsx("div", { className: "flex h-full w-full items-center justify-center bg-linear-to-b from-bg2 via-bg to-bg/80" });
    }
    if (!mediaEntry?.src && !fallbackSrc) {
      return /* @__PURE__ */ jsx("div", { className: "flex h-full w-full items-center justify-center bg-linear-to-b from-bg2 via-bg to-bg/80 text-white/30", children: "Preview coming soon" });
    }
    return /* @__PURE__ */ jsx(
      ClientImage,
      {
  ...
  const handleScrollComplete = totalSlides > 1 ? onCycleComplete : void 0;
  return /* @__PURE__ */ jsx(
    ScrollableViewport,
    {
      isActive,
...
function PortfolioScreenShowcase({
  ...
  return /* @__PURE__ */ jsx(
    KeyboardNavigableContainer,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "relative h-full w-full overflow-hidden", children: slides.map((item, slideIndex) => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(
        ScrollableViewport,
        {
          isActive,
          isTransitioning: false,
          onScrollComplete: isActive && itemsLength > 1 ? onScrollComplete : void 0,
          speedPxPerSec: 98,
          resetOnActivate: true,
          showDevOverlay: true,
          className: "w-full h-full bg-gray-900 m-0 p-0",
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(
              "div",
              {
                ...
                onMouseDown: drag ? onMouseDown : void 0,
                onMouseMove: drag ? onMouseMove : void 0,
                onMouseUp: drag ? onMouseUp : void 0,
                onTouchStart: drag ? onTouchStart : void 0,
                onTouchMove: drag ? onTouchMove : void 0,
                onTouchEnd: drag ? onTouchEnd : void 0,
...
function TechStackLabel({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "relative p-2 transition-all duration-300 group-hover:scale-110 select-none", children: /* @__PURE__ */ jsx(
          "div",
          {
...
function TechStackSection({
  ...
  return /* @__PURE__ */ jsx("div", { className: `inner-section text-center lg:text-left ${className}`.trim(), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:grid lg:grid-cols-[1fr_3fr] gap-6 lg:gap-8 items-center", children: [
    /* @__PURE__ */ jsx("div", { className: "w-md", children: /* @__PURE__ */ jsxs("div", { className: "relative inline-block mb-6 leading-tight", children: [
      /* @__PURE__ */ jsx(
        Heading,
        {
          tagName: "h2",
...
const $$TestimonialCarouselVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": id, "class": `outer-section relative overflow-hidden ${className}`.trim() }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="inner-section"> ${(title || collectionTitle || description || heading) && renderTemplate`${renderComponent($$result2, "SectionHeader", $$SectionHeader, { "title": title ?? collectionTitle, "heading": heading ?? title ?? collectionTitle, "description": description, "className": "text-section", "headingClassName": "mb-6", "descriptionClassName": "large-text" })}`} ${safeItems.length > 0 && renderTemplate`${renderComponent($$result2, "TestimonialCarousel", TestimonialCarousel, { "client:visible": true, "items": safeItems, "slidesPerView": { base: 1, lg: 2 }, "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/TestimonialCarousel", "client:component-export": "default" })}`} ${showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl) && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result2, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> ` })}`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialCarouselVariant.astro", void 0);

const $$file = "/Users/griffinsurett/coding/2025-Website-Projects/2026/griffinswebservices/src/components/ContentRenderer/variants/TestimonialCarouselVariant.astro";
const $$url = undefined;
...
export { FilterTabs as F, PortfolioScreenShowcase as P, TechStackSection as T, __vite_glob_0_29 as _, getAuthorName as a, FilteredPortfolioCarousel as b, PortfolioCarousel as c, TestimonialCard as d, getImageSrc as g };
