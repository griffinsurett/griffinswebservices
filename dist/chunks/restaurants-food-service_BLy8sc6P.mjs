...
function _createMdxContent(props) {
  ...
  return createVNode(_components.p, {
    children: "When someone’s hungry and searching, you have seconds to win them over. We create fast, mobile-optimized sites that showcase your food beautifully, make online ordering seamless, and turn first-time visitors into regulars."
  });
}
