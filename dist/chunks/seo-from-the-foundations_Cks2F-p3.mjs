...
import { a as Icon } from './ui-primitives_qUXBbRTf.mjs';
...
function GoogleListing({
  ...
  return /* @__PURE__ */ jsxs(DecorativeWrapper, { className: `relative bg-bg2 rounded-lg p-4 text-left border border-text/10 overflow-hidden ${className}`, children: [
