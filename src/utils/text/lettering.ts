...
/**
 * Split text into word groups while preserving per-letter indices for animation.
 * Wrapping can then happen between words instead of between individual letters.
 */
