      ...
      <div className="bg-[linear-gradient(180deg,#12141A,#0E1015)] p-3">
        ...
        <div className="relative h-[11rem] overflow-hidden rounded-[1.15rem] border border-white/14 bg-[#13192B]">
          ...
          >
            ...
            <div
              className={`absolute right-3 top-[2.8rem] w-[4.9rem] rounded-[0.85rem] border border-soft-strong bg-[#1A2240]/95 p-2 shadow-[0_16px_30px_rgba(0,0,0,0.3)] transition-all duration-700 ${
                showContentCard
