// src/components/starter/Button/variants/MenuItemButton.tsx
/**
 * Link Button Variant
 * 
...
export default function MenuItemButton({
  ...
  return (
    <ButtonBase
      {...props}
      className={`${baseClasses} inline-flex w-auto items-center justify-start font-normal text-2xl lg:text-3xl transition-all`}
