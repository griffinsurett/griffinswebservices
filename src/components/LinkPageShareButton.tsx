  ...
  return (
    <>
      ...
      <Modal
        ...
        className="card-bg light:bg-white/96 dark:bg-primary-light/6 border border-[var(--color-border-soft)] shadow-2xl backdrop-blur-xl w-full max-w-[36rem] rounded-t-[2rem] sm:rounded-[2rem] px-5 pb-6 pt-8 sm:px-6 sm:pb-7 sm:pt-9"
