...
import { isTrackingAllowed } from '@/integrations/preferences/consent/utils/consent';
import type { CookieCategory } from '@/integrations/preferences/consent/components/types';
