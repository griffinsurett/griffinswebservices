...
import Section from "@/integrations/preferences/controls/components/Section";
import SliderControl from "@/integrations/preferences/controls/components/SliderControl";
