...
Our pricing estimator and chat assistant are powered by the **OpenAI API**. By using these features, you acknowledge and agree that:

- Input data you provide (business details, messages) is transmitted to OpenAI for processing.
...
- AI-generated outputs (estimates, chat responses) are provided for informational purposes only and do not constitute professional advice or a binding quote.
- We are not liable for inaccuracies in AI-generated content.

### {sectionNumber}.2 Calendly
