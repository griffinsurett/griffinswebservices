...
import TwoColumnImageVariant from "@/components/ContentRenderer/variants/TwoColumnImageVariant.astro";
...
>
  <div class="space-y-4 text-lg text-muted leading-relaxed">
    <p>
      You didn't start your business to become a web designer. You have customers to serve, a team to lead, a company to grow.
    </p>
    <p>
      But here's the truth: most of your competitors have terrible websites—or none at all. That's not a problem. <strong class="text-heading">That's an opportunity.</strong>
    </p>
    <p>
      A professional website instantly positions you as the credible choice. The one who shows up on Google. The one who looks established. The one customers trust before they ever call.
    </p>
    <p class="text-heading font-medium text-xl">
      We build that advantage for you.
    </p>
  </div>
</TwoColumnImageVariant>
...
>
  ...
  <div class="flex flex-wrap items-start justify-left gap-4">
    <Button
      client:visible
      href="#services-quote-hero"
      variant="primary"
  ...
  <div class="inner-section">
    ...
    <div class="grid gap-4 md:grid-cols-3 mb-16">
      <div class="p-6 rounded-2xl border border-accent/20 bg-accent/5 text-center">
        <p class="text-xs uppercase tracking-[0.2em] text-accent font-semibold mb-1">Timeline</p>
        <p class="text-heading text-2xl font-bold">3-5 weeks</p>
        <p class="text-muted text-sm">to launch</p>
      </div>
      <div class="p-6 rounded-2xl border border-accent/20 bg-accent/5 text-center">
...
<ContentRenderer
  ...
  rightItems={[
    ...
    { title: "You need it done yesterday", description: "Good websites take time. If you need something in 48 hours, we're not the right fit." },
...
<section class="outer-section bg-bg2 relative">
  ...
  <div class="inner-section">
    <SectionHeader
      title="The Process"
      headingBefore="From first call to"
      headingEmphasis="live website"
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
      <div class="space-y-4">
        ...
        <p class="text-muted text-sm leading-relaxed">
          We learn about your business, goals, and customers. You learn about our process and pricing. No pressure—just a conversation to see if we're a fit.
        </p>
      </div>

      <div class="space-y-4">
        <div class="flex items-center gap-3">
          <span class="flex h-10 w-10 items-center justify-center rounded-full bg-accent/15 text-accent font-bold">2</span>
          <h3 class="font-semibold text-heading">Strategy & Design</h3>
        </div>
        <p class="text-muted text-sm leading-relaxed">
          We map out your site structure, create wireframes, and design your custom look. You'll see mockups and provide feedback before we build anything.
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-muted text-sm leading-relaxed">
          We build your site with clean code, fast hosting, and SEO best practices. You'll have access to a staging site to review progress and request changes.
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-muted text-sm leading-relaxed">
          We go live, train you on updates, and provide documentation. Then we stick around—hosting, maintenance, and support whenever you need it.
        </p>
      </div>
    </div>
