...
---
  ...
  <section>
    ...
    <p>
      At Griffin's Web Services, we've already started implementing both <code>llms.txt</code> and <code>llms-full.txt</code> standards across our own websites and client projects where it makes sense.
    </p>
    <p>
